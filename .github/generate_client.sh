...
# Module name
module_parent_path="github.com/itera-io"
module_name="taikungoclient"
...
swagger generate client -c "client" -f swagger-patch.json -A "${module_parent_path}/${module_name}" $@
...
# Tidy go module
go mod tidy && echo "Tidied ${module_parent_path}/${module_name} module"
