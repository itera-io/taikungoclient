...
func (r ApiVirtualClusterCreateRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
func (a *VirtualClusterAPIService) VirtualClusterCreateExecute(r ApiVirtualClusterCreateRequest) (map[string]interface{}, *http.Response, error) {
	var (
