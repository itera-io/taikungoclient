...
func (o *AzureImageList) GetImages() BoundImagesForProjectDto {
...
// and a boolean to check if the value has been set.
func (o *AzureImageList) GetImagesOk() (*BoundImagesForProjectDto, bool) {
	if o == nil || IsNil(o.Images) {
		return nil, false
	}
...
func (o *AzureImageList) HasImages() bool {
	if o != nil && !IsNil(o.Images) {
		return true
	}
...
func (o *AzureImageList) SetImages(v BoundImagesForProjectDto) {
	o.Images = &v
}
