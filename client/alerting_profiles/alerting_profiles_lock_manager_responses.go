...
func (o *AlertingProfilesLockManagerReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewAlertingProfilesLockManagerTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewAlertingProfilesLockManagerTooManyRequests creates a AlertingProfilesLockManagerTooManyRequests with default headers values
func NewAlertingProfilesLockManagerTooManyRequests() *AlertingProfilesLockManagerTooManyRequests {
	return &AlertingProfilesLockManagerTooManyRequests{}
}

/* AlertingProfilesLockManagerTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type AlertingProfilesLockManagerTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *AlertingProfilesLockManagerTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/AlertingProfiles/lockmanager][%d] alertingProfilesLockManagerTooManyRequests  %+v", 429, o.Payload)
}
func (o *AlertingProfilesLockManagerTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *AlertingProfilesLockManagerTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
