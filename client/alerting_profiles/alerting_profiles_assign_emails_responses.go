...
func (o *AlertingProfilesAssignEmailsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewAlertingProfilesAssignEmailsTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewAlertingProfilesAssignEmailsTooManyRequests creates a AlertingProfilesAssignEmailsTooManyRequests with default headers values
func NewAlertingProfilesAssignEmailsTooManyRequests() *AlertingProfilesAssignEmailsTooManyRequests {
	return &AlertingProfilesAssignEmailsTooManyRequests{}
}

/* AlertingProfilesAssignEmailsTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type AlertingProfilesAssignEmailsTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *AlertingProfilesAssignEmailsTooManyRequests) Error() string {
	return fmt.Sprintf("[PUT /api/v{v}/AlertingProfiles/assignemails/{id}][%d] alertingProfilesAssignEmailsTooManyRequests  %+v", 429, o.Payload)
}
func (o *AlertingProfilesAssignEmailsTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *AlertingProfilesAssignEmailsTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
