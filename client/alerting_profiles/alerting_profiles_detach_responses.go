...
// Code gets the status code for the alerting profiles detach o k response
func (o *AlertingProfilesDetachOK) Code() int {
	return 200
}

func (o *AlertingProfilesDetachOK) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/AlertingProfiles/detach][%d] alertingProfilesDetachOK ", 200)
}
...
// Code gets the status code for the alerting profiles detach bad request response
func (o *AlertingProfilesDetachBadRequest) Code() int {
	return 400
}
...
// Code gets the status code for the alerting profiles detach unauthorized response
func (o *AlertingProfilesDetachUnauthorized) Code() int {
	return 401
}
...
// Code gets the status code for the alerting profiles detach forbidden response
func (o *AlertingProfilesDetachForbidden) Code() int {
	return 403
}
...
// Code gets the status code for the alerting profiles detach not found response
func (o *AlertingProfilesDetachNotFound) Code() int {
	return 404
}
...
// Code gets the status code for the alerting profiles detach internal server error response
func (o *AlertingProfilesDetachInternalServerError) Code() int {
	return 500
}
