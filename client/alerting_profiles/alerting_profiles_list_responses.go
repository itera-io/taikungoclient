...
func (o *AlertingProfilesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewAlertingProfilesListTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewAlertingProfilesListTooManyRequests creates a AlertingProfilesListTooManyRequests with default headers values
func NewAlertingProfilesListTooManyRequests() *AlertingProfilesListTooManyRequests {
	return &AlertingProfilesListTooManyRequests{}
}

/* AlertingProfilesListTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type AlertingProfilesListTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *AlertingProfilesListTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /api/v{v}/AlertingProfiles][%d] alertingProfilesListTooManyRequests  %+v", 429, o.Payload)
}
func (o *AlertingProfilesListTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *AlertingProfilesListTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
