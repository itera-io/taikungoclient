...
func NewProjectAppDetailsDto(id int32, name string, namespace string, status EInstanceStatus, version string, catalogId int32, catalogName string, catalogAppName string, appRepoName string, logo NullableString, values string, autoSync bool, releaseNotes NullableString, projectName string, helmResult string, projectId int32, hasJsonSchema bool, catalogAppId int32, packageId string, logs NullableString, taikunLinkEnabled bool, projectAppParams []ProjectAppParamDto) *ProjectAppDetailsDto {
