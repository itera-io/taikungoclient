...
func (o *SubscriptionSubscriptionForLandingPageReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewSubscriptionSubscriptionForLandingPageTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewSubscriptionSubscriptionForLandingPageTooManyRequests creates a SubscriptionSubscriptionForLandingPageTooManyRequests with default headers values
func NewSubscriptionSubscriptionForLandingPageTooManyRequests() *SubscriptionSubscriptionForLandingPageTooManyRequests {
	return &SubscriptionSubscriptionForLandingPageTooManyRequests{}
}

/* SubscriptionSubscriptionForLandingPageTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type SubscriptionSubscriptionForLandingPageTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *SubscriptionSubscriptionForLandingPageTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /api/v{v}/Subscription/public][%d] subscriptionSubscriptionForLandingPageTooManyRequests  %+v", 429, o.Payload)
}
func (o *SubscriptionSubscriptionForLandingPageTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *SubscriptionSubscriptionForLandingPageTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
