...
func (o *PreDefinedQueriesUpdatePrometheusDashboardReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewPreDefinedQueriesUpdatePrometheusDashboardTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewPreDefinedQueriesUpdatePrometheusDashboardTooManyRequests creates a PreDefinedQueriesUpdatePrometheusDashboardTooManyRequests with default headers values
func NewPreDefinedQueriesUpdatePrometheusDashboardTooManyRequests() *PreDefinedQueriesUpdatePrometheusDashboardTooManyRequests {
	return &PreDefinedQueriesUpdatePrometheusDashboardTooManyRequests{}
}

/* PreDefinedQueriesUpdatePrometheusDashboardTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type PreDefinedQueriesUpdatePrometheusDashboardTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *PreDefinedQueriesUpdatePrometheusDashboardTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/PreDefinedQueries/prometheus/dashboard/update][%d] preDefinedQueriesUpdatePrometheusDashboardTooManyRequests  %+v", 429, o.Payload)
}
func (o *PreDefinedQueriesUpdatePrometheusDashboardTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *PreDefinedQueriesUpdatePrometheusDashboardTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
