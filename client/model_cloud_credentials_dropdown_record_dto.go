...
func NewCloudCredentialsDropdownRecordDto(id int32, name string, cloudType CloudType, projects []ProjectWithFlavorsAndImagesDto) *CloudCredentialsDropdownRecordDto {
