...
func (r ApiAdminExtendTrialPeriodRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *AdminAPIService) AdminExtendTrialPeriodExecute(r ApiAdminExtendTrialPeriodRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiAdminMoveOrganizationRequest struct {
	ctx context.Context
	ApiService *AdminAPIService
	moveOrganizationCommand *MoveOrganizationCommand
}

func (r ApiAdminMoveOrganizationRequest) MoveOrganizationCommand(moveOrganizationCommand MoveOrganizationCommand) ApiAdminMoveOrganizationRequest {
	r.moveOrganizationCommand = &moveOrganizationCommand
	return r
}

func (r ApiAdminMoveOrganizationRequest) Execute() (*http.Response, error) {
	return r.ApiService.AdminMoveOrganizationExecute(r)
}

/*
AdminMoveOrganization Move organization

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiAdminMoveOrganizationRequest
*/
func (a *AdminAPIService) AdminMoveOrganization(ctx context.Context) ApiAdminMoveOrganizationRequest {
	return ApiAdminMoveOrganizationRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *AdminAPIService) AdminMoveOrganizationExecute(r ApiAdminMoveOrganizationRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AdminAPIService.AdminMoveOrganization")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/admin/orgnanizations/move"
	...
	// body params
	localVarPostBody = r.moveOrganizationCommand
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["Bearer"]; ok {
...
func (r ApiAdminRemoveOwnerRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *AdminAPIService) AdminRemoveOwnerExecute(r ApiAdminRemoveOwnerRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
