...
func (o *SlackCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewSlackCreateTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewSlackCreateTooManyRequests creates a SlackCreateTooManyRequests with default headers values
func NewSlackCreateTooManyRequests() *SlackCreateTooManyRequests {
	return &SlackCreateTooManyRequests{}
}

/* SlackCreateTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type SlackCreateTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *SlackCreateTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Slack][%d] slackCreateTooManyRequests  %+v", 429, o.Payload)
}
func (o *SlackCreateTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *SlackCreateTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
