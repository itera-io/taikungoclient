...
func (r ApiAuthVerify2faRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *AuthManagementAPIService) AuthVerify2faExecute(r ApiAuthVerify2faRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	if r.verifyTwoFactorTokenCommand == nil {
		return nil, reportError("verifyTwoFactorTokenCommand is required and must be specified")
	}
