...
func (r ApiSecuritygroupEditRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
func (a *SecurityGroupAPIService) SecuritygroupEditExecute(r ApiSecuritygroupEditRequest) (map[string]interface{}, *http.Response, error) {
	var (
