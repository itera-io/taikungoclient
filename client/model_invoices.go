...
func NewInvoices(data []InvoiceListDto, limit int32, hasMore bool, totalCount int64, offset int32) *Invoices {
	this := Invoices{}
	this.Data = data
	this.Limit = limit
...
func (o *Invoices) GetLimit() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Invoices) GetLimitOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Limit, true
...
func (o *Invoices) SetLimit(v int32) {
	o.Limit = v
}

// GetHasMore returns the HasMore field value
func (o *Invoices) GetHasMore() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Invoices) GetHasMoreOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Invoices) SetHasMore(v bool) {
	o.HasMore = v
}

// GetTotalCount returns the TotalCount field value
func (o *Invoices) GetTotalCount() int64 {
	if o == nil {
		var ret int64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Invoices) GetTotalCountOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Invoices) SetTotalCount(v int64) {
	o.TotalCount = v
}

// GetOffset returns the Offset field value
func (o *Invoices) GetOffset() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Invoices) GetOffsetOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Invoices) GetNextOffsetOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Invoices) HasNextOffset() bool {
