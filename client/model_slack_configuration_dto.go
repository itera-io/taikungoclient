...
func NewSlackConfigurationDto(id int32, name string, url string, channel string, organizationName string, organizationId NullableInt32, slackType SlackType) *SlackConfigurationDto {
