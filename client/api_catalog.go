...
type ApiCatalogAddProjectRequest struct {
	...
	addProjectsToCatalogCommand *AddProjectsToCatalogCommand
}

func (r ApiCatalogAddProjectRequest) AddProjectsToCatalogCommand(addProjectsToCatalogCommand AddProjectsToCatalogCommand) ApiCatalogAddProjectRequest {
	r.addProjectsToCatalogCommand = &addProjectsToCatalogCommand
	return r
}
...
*/
func (a *CatalogAPIService) CatalogAddProject(ctx context.Context) ApiCatalogAddProjectRequest {
	return ApiCatalogAddProjectRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *CatalogAPIService) CatalogAddProjectExecute(r ApiCatalogAddProjectRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/catalog/add-project"
	...
	// body params
	localVarPostBody = r.addProjectsToCatalogCommand
	if r.ctx != nil {
