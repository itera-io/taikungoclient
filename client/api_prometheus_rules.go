...
type ApiPrometheusrulesDeleteOrganizationsRequest struct {
	...
	ApiService *PrometheusRulesAPIService
	id int32
	deleteOrganizationsDto *[]DeleteOrganizationsDto
}

func (r ApiPrometheusrulesDeleteOrganizationsRequest) DeleteOrganizationsDto(deleteOrganizationsDto []DeleteOrganizationsDto) ApiPrometheusrulesDeleteOrganizationsRequest {
	r.deleteOrganizationsDto = &deleteOrganizationsDto
	return r
}
...
func (a *PrometheusRulesAPIService) PrometheusrulesDeleteOrganizationsExecute(r ApiPrometheusrulesDeleteOrganizationsRequest) (*http.Response, error) {
	...
	// body params
	localVarPostBody = r.deleteOrganizationsDto
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["Bearer"]; ok {
