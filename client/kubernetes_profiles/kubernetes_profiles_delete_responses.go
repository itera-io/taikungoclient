...
func (o *KubernetesProfilesDeleteOK) Error() string {
	return fmt.Sprintf("[DELETE /api/v{v}/KubernetesProfiles/{id}][%d] kubernetesProfilesDeleteOK ", 200)
}
...
func (o *KubernetesProfilesDeleteBadRequest) GetPayload() interface{} {
	return o.Payload
}
