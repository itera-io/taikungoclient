...
func (o *ProjectQuotasListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewProjectQuotasListTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewProjectQuotasListTooManyRequests creates a ProjectQuotasListTooManyRequests with default headers values
func NewProjectQuotasListTooManyRequests() *ProjectQuotasListTooManyRequests {
	return &ProjectQuotasListTooManyRequests{}
}

/* ProjectQuotasListTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type ProjectQuotasListTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *ProjectQuotasListTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /api/v{v}/ProjectQuotas][%d] projectQuotasListTooManyRequests  %+v", 429, o.Payload)
}
func (o *ProjectQuotasListTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *ProjectQuotasListTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
