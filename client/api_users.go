...
func (r ApiUsersDropdownRequest) Limit(limit int32) ApiUsersDropdownRequest {
	r.limit = &limit
	return r
}

func (r ApiUsersDropdownRequest) Offset(offset int32) ApiUsersDropdownRequest {
	r.offset = &offset
	return r
}
...
func (r ApiUsersDropdownRequest) Execute() (*UserByOrgProjectDropdownList, *http.Response, error) {
...
func (a *UsersAPIService) UsersDropdownExecute(r ApiUsersDropdownRequest) (*UserByOrgProjectDropdownList, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/users/dropdown"
...
func (r ApiUsersManageRoleRequest) ManageRoleCommand(manageRoleCommand ManageRoleCommand) ApiUsersManageRoleRequest {
	r.manageRoleCommand = &manageRoleCommand
	return r
}

func (r ApiUsersManageRoleRequest) Execute() (*http.Response, error) {
	return r.ApiService.UsersManageRoleExecute(r)
}
...
func (a *UsersAPIService) UsersManageRoleExecute(r ApiUsersManageRoleRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/users/manage-role"
	...
	// body params
	localVarPostBody = r.manageRoleCommand
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["Bearer"]; ok {
