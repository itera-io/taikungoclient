...
func NewProjectTemplateListDto(id int32, name string, monitoringEnabled bool, backupEnabled bool, allowFullSpotKubernetes bool, allowSpotVms bool, allowSpotWorkers bool, kubernetesVersion string, organizationName string, organizationId NullableInt32) *ProjectTemplateListDto {
