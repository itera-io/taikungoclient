...
func (o *KubeConfigRoleListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewKubeConfigRoleListTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewKubeConfigRoleListTooManyRequests creates a KubeConfigRoleListTooManyRequests with default headers values
func NewKubeConfigRoleListTooManyRequests() *KubeConfigRoleListTooManyRequests {
	return &KubeConfigRoleListTooManyRequests{}
}

/* KubeConfigRoleListTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type KubeConfigRoleListTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *KubeConfigRoleListTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /api/v{v}/KubeConfigRole][%d] kubeConfigRoleListTooManyRequests  %+v", 429, o.Payload)
}
func (o *KubeConfigRoleListTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *KubeConfigRoleListTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
