...
func (o *PrometheusBindRulesParams) WithBody(body PrometheusBindRulesBody) *PrometheusBindRulesParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the prometheus bind rules params
func (o *PrometheusBindRulesParams) SetBody(body PrometheusBindRulesBody) {
	o.Body = body
}
