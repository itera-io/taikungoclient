...
func (o *PrometheusUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewPrometheusUpdateTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewPrometheusUpdateTooManyRequests creates a PrometheusUpdateTooManyRequests with default headers values
func NewPrometheusUpdateTooManyRequests() *PrometheusUpdateTooManyRequests {
	return &PrometheusUpdateTooManyRequests{}
}

/* PrometheusUpdateTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type PrometheusUpdateTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *PrometheusUpdateTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Prometheus/update/{id}][%d] prometheusUpdateTooManyRequests  %+v", 429, o.Payload)
}
func (o *PrometheusUpdateTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *PrometheusUpdateTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
