...
func (o *OrganizationsUpdateSubscriptionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewOrganizationsUpdateSubscriptionTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewOrganizationsUpdateSubscriptionTooManyRequests creates a OrganizationsUpdateSubscriptionTooManyRequests with default headers values
func NewOrganizationsUpdateSubscriptionTooManyRequests() *OrganizationsUpdateSubscriptionTooManyRequests {
	return &OrganizationsUpdateSubscriptionTooManyRequests{}
}

/* OrganizationsUpdateSubscriptionTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type OrganizationsUpdateSubscriptionTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *OrganizationsUpdateSubscriptionTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Organizations/updatesubscription][%d] organizationsUpdateSubscriptionTooManyRequests  %+v", 429, o.Payload)
}
func (o *OrganizationsUpdateSubscriptionTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *OrganizationsUpdateSubscriptionTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
