...
func (o *OrganizationsUpdatePaymentMethodReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewOrganizationsUpdatePaymentMethodTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewOrganizationsUpdatePaymentMethodTooManyRequests creates a OrganizationsUpdatePaymentMethodTooManyRequests with default headers values
func NewOrganizationsUpdatePaymentMethodTooManyRequests() *OrganizationsUpdatePaymentMethodTooManyRequests {
	return &OrganizationsUpdatePaymentMethodTooManyRequests{}
}

/* OrganizationsUpdatePaymentMethodTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type OrganizationsUpdatePaymentMethodTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *OrganizationsUpdatePaymentMethodTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Organizations/updatepaymentmethod][%d] organizationsUpdatePaymentMethodTooManyRequests  %+v", 429, o.Payload)
}
func (o *OrganizationsUpdatePaymentMethodTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *OrganizationsUpdatePaymentMethodTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
