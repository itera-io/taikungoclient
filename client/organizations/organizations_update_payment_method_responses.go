...
func (o *OrganizationsUpdatePaymentMethodOK) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Organizations/updatepaymentmethod][%d] organizationsUpdatePaymentMethodOK ", 200)
}
...
func (o *OrganizationsUpdatePaymentMethodBadRequest) GetPayload() interface{} {
	return o.Payload
}
