...
func (o *OrganizationsToggleKeycloakReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewOrganizationsToggleKeycloakTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewOrganizationsToggleKeycloakTooManyRequests creates a OrganizationsToggleKeycloakTooManyRequests with default headers values
func NewOrganizationsToggleKeycloakTooManyRequests() *OrganizationsToggleKeycloakTooManyRequests {
	return &OrganizationsToggleKeycloakTooManyRequests{}
}

/* OrganizationsToggleKeycloakTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type OrganizationsToggleKeycloakTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *OrganizationsToggleKeycloakTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Organizations/toggle/keycloak][%d] organizationsToggleKeycloakTooManyRequests  %+v", 429, o.Payload)
}
func (o *OrganizationsToggleKeycloakTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *OrganizationsToggleKeycloakTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
