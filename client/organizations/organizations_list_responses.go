...
func (o *OrganizationsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewOrganizationsListTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewOrganizationsListTooManyRequests creates a OrganizationsListTooManyRequests with default headers values
func NewOrganizationsListTooManyRequests() *OrganizationsListTooManyRequests {
	return &OrganizationsListTooManyRequests{}
}

/* OrganizationsListTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type OrganizationsListTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *OrganizationsListTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /api/v{v}/Organizations][%d] organizationsListTooManyRequests  %+v", 429, o.Payload)
}
func (o *OrganizationsListTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *OrganizationsListTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
