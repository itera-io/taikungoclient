...
func (r ApiInfraBillingSummaryCreateRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
func (a *InfraBillingSummaryAPIService) InfraBillingSummaryCreateExecute(r ApiInfraBillingSummaryCreateRequest) (map[string]interface{}, *http.Response, error) {
	var (
