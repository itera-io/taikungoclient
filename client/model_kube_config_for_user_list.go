...
type KubeConfigForUserList struct {
	...
	CanAdd ButtonStatusDto2 `json:"canAdd"`
}
...
func NewKubeConfigForUserList(data []KubeConfigForUserDto, totalCount int32, canAdd ButtonStatusDto2) *KubeConfigForUserList {
...
func (o *KubeConfigForUserList) GetCanAdd() ButtonStatusDto2 {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *KubeConfigForUserList) GetCanAddOk() (*ButtonStatusDto2, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *KubeConfigForUserList) SetCanAdd(v ButtonStatusDto2) {
	o.CanAdd = v
}
