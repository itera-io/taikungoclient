...
func (r ApiInfraCreateRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
func (a *InfraAPIService) InfraCreateExecute(r ApiInfraCreateRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	if r.createInfraProductCommand == nil {
		return localVarReturnValue, nil, reportError("createInfraProductCommand is required and must be specified")
	}
