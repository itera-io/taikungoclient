...
func NewAdminProjectsResponseData(id int32, name string, organizationName string, isLocked bool, kubernetesCurrentVersion string, kubesprayCurrentVersion string, status ProjectStatus, serversCount int32, tcu int32, createdAt string, cloudType CloudType) *AdminProjectsResponseData {
