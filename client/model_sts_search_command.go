...
func (o *StsSearchCommand) HasIncludePublicImportedClusters() bool {
...
func (o *StsSearchCommand) SetIncludePublicImportedClustersNil() {
...
func (o *StsSearchCommand) UnsetIncludePublicImportedClusters() {
...
func (o *StsSearchCommand) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varStsSearchCommand)
