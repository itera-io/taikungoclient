...
func NewProjectListForAlert(id int32, name string, token string, status string, organizationId int32, health string, isKubernetes bool, isLocked bool, isMonitoringEnabled bool, hasKubeConfigFile bool, monitoringCredential MonitoringCredentialsListDto, kubernetesAlerts []KubernetesAlertDtoForPoller, kubernetesCurrentVersion string, totalServersCount int32) *ProjectListForAlert {
