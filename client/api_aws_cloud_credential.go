...
func (r ApiAwsEfsFileSystemByVpcListRequest) AwsFileSystemsCommand(awsFileSystemsCommand AwsFileSystemsCommand) ApiAwsEfsFileSystemByVpcListRequest {
	r.awsFileSystemsCommand = &awsFileSystemsCommand
	return r
}

func (r ApiAwsEfsFileSystemByVpcListRequest) Execute() ([]EfsFileSystemDto, *http.Response, error) {
	return r.ApiService.AwsEfsFileSystemByVpcListExecute(r)
}
...
func (a *AWSCloudCredentialAPIService) AwsEfsFileSystemByVpcListExecute(r ApiAwsEfsFileSystemByVpcListRequest) ([]EfsFileSystemDto, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/aws/efs-file-system-by-vpc-list"
	...
	// body params
	localVarPostBody = r.awsFileSystemsCommand
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["Bearer"]; ok {
...
func (r ApiAwsSubnetListRequest) AwsSubnetListCommand(awsSubnetListCommand AwsSubnetListCommand) ApiAwsSubnetListRequest {
	r.awsSubnetListCommand = &awsSubnetListCommand
	return r
}

func (r ApiAwsSubnetListRequest) Execute() ([]AwsSubnetDto, *http.Response, error) {
	return r.ApiService.AwsSubnetListExecute(r)
}
...
func (a *AWSCloudCredentialAPIService) AwsSubnetListExecute(r ApiAwsSubnetListRequest) ([]AwsSubnetDto, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/aws/subnet-list"
	...
	// body params
	localVarPostBody = r.awsSubnetListCommand
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["Bearer"]; ok {
...
func (r ApiAwsVpcListRequest) AwsVpcListCommand(awsVpcListCommand AwsVpcListCommand) ApiAwsVpcListRequest {
	r.awsVpcListCommand = &awsVpcListCommand
	return r
}

func (r ApiAwsVpcListRequest) Execute() ([]AwsVpcDto, *http.Response, error) {
	return r.ApiService.AwsVpcListExecute(r)
}
...
func (a *AWSCloudCredentialAPIService) AwsVpcListExecute(r ApiAwsVpcListRequest) ([]AwsVpcDto, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/aws/vpc-list"
	...
	// body params
	localVarPostBody = r.awsVpcListCommand
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["Bearer"]; ok {
