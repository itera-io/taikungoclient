...
func NewBillingCredentialsSearchList(data []CommonSearchResponseData, totalCount int32) *BillingCredentialsSearchList {
...
func (o *BillingCredentialsSearchList) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varBillingCredentialsSearchList)
