...
func NewGoogleFlavorDto(name string, cpu NullableInt32, ram NullableFloat64, linuxPrice NullableFloat64, windowsPrice NullableFloat64, linuxSpotPrice NullableFloat64, windowsSpotPrice NullableFloat64, description NullableString) *GoogleFlavorDto {
...
func (o *GoogleFlavorDto) GetDescription() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *GoogleFlavorDto) GetDescriptionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GoogleFlavorDto) SetDescription(v string) {
	o.Description.Set(&v)
}
