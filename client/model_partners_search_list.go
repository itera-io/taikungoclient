...
func (o *PartnersSearchList) GetTotalCount() int64 {
...
// and a boolean to check if the value has been set.
func (o *PartnersSearchList) GetTotalCountOk() (*int64, bool) {
	if o == nil || IsNil(o.TotalCount) {
		return nil, false
	}
...
func (o *PartnersSearchList) SetTotalCount(v int64) {
	o.TotalCount = &v
}
...
func (o *PartnersSearchList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varPartnersSearchList)
