...
func (r ApiPrometheusbillingsCreateRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
func (a *PrometheusBillingsAPIService) PrometheusbillingsCreateExecute(r ApiPrometheusbillingsCreateRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	if r.prometheusBillingCreateCommand == nil {
		return localVarReturnValue, nil, reportError("prometheusBillingCreateCommand is required and must be specified")
	}
