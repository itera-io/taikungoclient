...
// Code gets the status code for the ticket article list o k response
func (o *TicketArticleListOK) Code() int {
	return 200
}
...
// Code gets the status code for the ticket article list bad request response
func (o *TicketArticleListBadRequest) Code() int {
	return 400
}
...
// Code gets the status code for the ticket article list unauthorized response
func (o *TicketArticleListUnauthorized) Code() int {
	return 401
}
...
// Code gets the status code for the ticket article list forbidden response
func (o *TicketArticleListForbidden) Code() int {
	return 403
}
...
// Code gets the status code for the ticket article list not found response
func (o *TicketArticleListNotFound) Code() int {
	return 404
}
...
// Code gets the status code for the ticket article list internal server error response
func (o *TicketArticleListInternalServerError) Code() int {
	return 500
}
