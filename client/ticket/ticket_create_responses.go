...
func (o *TicketCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewTicketCreateTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewTicketCreateTooManyRequests creates a TicketCreateTooManyRequests with default headers values
func NewTicketCreateTooManyRequests() *TicketCreateTooManyRequests {
	return &TicketCreateTooManyRequests{}
}

/* TicketCreateTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type TicketCreateTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *TicketCreateTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Ticket/create][%d] ticketCreateTooManyRequests  %+v", 429, o.Payload)
}
func (o *TicketCreateTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *TicketCreateTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
