...
func (o *TicketEditReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewTicketEditTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewTicketEditTooManyRequests creates a TicketEditTooManyRequests with default headers values
func NewTicketEditTooManyRequests() *TicketEditTooManyRequests {
	return &TicketEditTooManyRequests{}
}

/* TicketEditTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type TicketEditTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *TicketEditTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Ticket/edit][%d] ticketEditTooManyRequests  %+v", 429, o.Payload)
}
func (o *TicketEditTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *TicketEditTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
