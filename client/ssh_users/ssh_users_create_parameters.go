...
func (o *SSHUsersCreateParams) WithBody(body SSHUsersCreateBody) *SSHUsersCreateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the Ssh users create params
func (o *SSHUsersCreateParams) SetBody(body SSHUsersCreateBody) {
	o.Body = body
}
