...
func NewStandaloneProfileListDto(id int32, name string, revision int32, isLocked bool, standAloneProfileSecurityGroups []StandaloneProfileSecurityGroupListDto) *StandaloneProfileListDto {
