...
func (r ApiKubernetesDescribeResourceRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *KubernetesAPIService) KubernetesDescribeResourceExecute(r ApiKubernetesDescribeResourceRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
