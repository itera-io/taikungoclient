...
func NewKubernetesProfilesLockManagerCommand(id int32, mode string) *KubernetesProfilesLockManagerCommand {
...
func (o *KubernetesProfilesLockManagerCommand) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varKubernetesProfilesLockManagerCommand)
