...
func NewProjectWithFlavorsAndImagesDto(id int32, name string, flavors []string, images []string, imageNames []string, isReady bool) *ProjectWithFlavorsAndImagesDto {
