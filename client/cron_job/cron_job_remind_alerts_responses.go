...
func (o *CronJobRemindAlertsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewCronJobRemindAlertsTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCronJobRemindAlertsTooManyRequests creates a CronJobRemindAlertsTooManyRequests with default headers values
func NewCronJobRemindAlertsTooManyRequests() *CronJobRemindAlertsTooManyRequests {
	return &CronJobRemindAlertsTooManyRequests{}
}

/* CronJobRemindAlertsTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type CronJobRemindAlertsTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *CronJobRemindAlertsTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/CronJob/remind-alerts][%d] cronJobRemindAlertsTooManyRequests  %+v", 429, o.Payload)
}
func (o *CronJobRemindAlertsTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *CronJobRemindAlertsTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
