...
func (o *CronJobUpdateProjectQuotaMessageReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewCronJobUpdateProjectQuotaMessageTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *CronJobUpdateProjectQuotaMessageBadRequest) GetPayload() *models.ValidationProblemDetails {
	return o.Payload
}
...
// NewCronJobUpdateProjectQuotaMessageTooManyRequests creates a CronJobUpdateProjectQuotaMessageTooManyRequests with default headers values
func NewCronJobUpdateProjectQuotaMessageTooManyRequests() *CronJobUpdateProjectQuotaMessageTooManyRequests {
	return &CronJobUpdateProjectQuotaMessageTooManyRequests{}
}

/* CronJobUpdateProjectQuotaMessageTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type CronJobUpdateProjectQuotaMessageTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *CronJobUpdateProjectQuotaMessageTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/CronJob/project-quota-message][%d] cronJobUpdateProjectQuotaMessageTooManyRequests  %+v", 429, o.Payload)
}
func (o *CronJobUpdateProjectQuotaMessageTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *CronJobUpdateProjectQuotaMessageTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
