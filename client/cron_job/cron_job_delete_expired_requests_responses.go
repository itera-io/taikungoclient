...
func (o *CronJobDeleteExpiredRequestsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewCronJobDeleteExpiredRequestsTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCronJobDeleteExpiredRequestsTooManyRequests creates a CronJobDeleteExpiredRequestsTooManyRequests with default headers values
func NewCronJobDeleteExpiredRequestsTooManyRequests() *CronJobDeleteExpiredRequestsTooManyRequests {
	return &CronJobDeleteExpiredRequestsTooManyRequests{}
}

/* CronJobDeleteExpiredRequestsTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type CronJobDeleteExpiredRequestsTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *CronJobDeleteExpiredRequestsTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/CronJob/taikun-requests][%d] cronJobDeleteExpiredRequestsTooManyRequests  %+v", 429, o.Payload)
}
func (o *CronJobDeleteExpiredRequestsTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *CronJobDeleteExpiredRequestsTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
