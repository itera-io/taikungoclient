...
func (o *CronJobSyncBackupCredentialsOK) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/CronJob/sync-backup-credentials][%d] cronJobSyncBackupCredentialsOK ", 200)
}
...
func (o *CronJobSyncBackupCredentialsBadRequest) GetPayload() interface{} {
	return o.Payload
}
