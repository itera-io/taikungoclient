...
func (o *CronJobDeleteExpiredRefreshTokensReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewCronJobDeleteExpiredRefreshTokensTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCronJobDeleteExpiredRefreshTokensTooManyRequests creates a CronJobDeleteExpiredRefreshTokensTooManyRequests with default headers values
func NewCronJobDeleteExpiredRefreshTokensTooManyRequests() *CronJobDeleteExpiredRefreshTokensTooManyRequests {
	return &CronJobDeleteExpiredRefreshTokensTooManyRequests{}
}

/* CronJobDeleteExpiredRefreshTokensTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type CronJobDeleteExpiredRefreshTokensTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *CronJobDeleteExpiredRefreshTokensTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/CronJob/refresh-tokens][%d] cronJobDeleteExpiredRefreshTokensTooManyRequests  %+v", 429, o.Payload)
}
func (o *CronJobDeleteExpiredRefreshTokensTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *CronJobDeleteExpiredRefreshTokensTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
