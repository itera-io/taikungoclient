...
func NewProjectAppList(data []InstanceAppListDto, limit int32, hasMore bool, totalCount int64, offset int32) *ProjectAppList {
	this := ProjectAppList{}
	this.Data = data
	this.Limit = limit
...
func (o *ProjectAppList) GetTotalCount() int64 {
	if o == nil {
		var ret int64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ProjectAppList) GetTotalCountOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ProjectAppList) SetTotalCount(v int64) {
	o.TotalCount = v
}
