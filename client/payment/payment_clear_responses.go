...
func (o *PaymentClearReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewPaymentClearTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewPaymentClearTooManyRequests creates a PaymentClearTooManyRequests with default headers values
func NewPaymentClearTooManyRequests() *PaymentClearTooManyRequests {
	return &PaymentClearTooManyRequests{}
}

/* PaymentClearTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type PaymentClearTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *PaymentClearTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Payment/clear][%d] paymentClearTooManyRequests  %+v", 429, o.Payload)
}
func (o *PaymentClearTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *PaymentClearTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
