...
func (o *AuthForgotPasswordReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewAuthForgotPasswordTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewAuthForgotPasswordTooManyRequests creates a AuthForgotPasswordTooManyRequests with default headers values
func NewAuthForgotPasswordTooManyRequests() *AuthForgotPasswordTooManyRequests {
	return &AuthForgotPasswordTooManyRequests{}
}

/* AuthForgotPasswordTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type AuthForgotPasswordTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *AuthForgotPasswordTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Auth/forgotpassword][%d] authForgotPasswordTooManyRequests  %+v", 429, o.Payload)
}
func (o *AuthForgotPasswordTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *AuthForgotPasswordTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
