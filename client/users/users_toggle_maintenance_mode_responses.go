...
func (o *UsersToggleMaintenanceModeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewUsersToggleMaintenanceModeTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUsersToggleMaintenanceModeTooManyRequests creates a UsersToggleMaintenanceModeTooManyRequests with default headers values
func NewUsersToggleMaintenanceModeTooManyRequests() *UsersToggleMaintenanceModeTooManyRequests {
	return &UsersToggleMaintenanceModeTooManyRequests{}
}

/* UsersToggleMaintenanceModeTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type UsersToggleMaintenanceModeTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *UsersToggleMaintenanceModeTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Users/togglemaintenancemode][%d] usersToggleMaintenanceModeTooManyRequests  %+v", 429, o.Payload)
}
func (o *UsersToggleMaintenanceModeTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *UsersToggleMaintenanceModeTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
