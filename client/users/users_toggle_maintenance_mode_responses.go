...
func (o *UsersToggleMaintenanceModeOK) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Users/togglemaintenancemode][%d] usersToggleMaintenanceModeOK ", 200)
}
...
func (o *UsersToggleMaintenanceModeBadRequest) GetPayload() interface{} {
	return o.Payload
}
