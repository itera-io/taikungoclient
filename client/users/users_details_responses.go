...
func (o *UsersDetailsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewUsersDetailsTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUsersDetailsTooManyRequests creates a UsersDetailsTooManyRequests with default headers values
func NewUsersDetailsTooManyRequests() *UsersDetailsTooManyRequests {
	return &UsersDetailsTooManyRequests{}
}

/* UsersDetailsTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type UsersDetailsTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *UsersDetailsTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /api/v{v}/Users/userinfo][%d] usersDetailsTooManyRequests  %+v", 429, o.Payload)
}
func (o *UsersDetailsTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *UsersDetailsTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
