...
func (o *UsersListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewUsersListTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUsersListTooManyRequests creates a UsersListTooManyRequests with default headers values
func NewUsersListTooManyRequests() *UsersListTooManyRequests {
	return &UsersListTooManyRequests{}
}

/* UsersListTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type UsersListTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *UsersListTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /api/v{v}/Users][%d] usersListTooManyRequests  %+v", 429, o.Payload)
}
func (o *UsersListTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *UsersListTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
