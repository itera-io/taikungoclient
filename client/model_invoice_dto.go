...
func NewInvoiceDto(id int32, name string, documentNumber string, organizationSubscriptionId int32, isPaid bool, requiredPaymentAction bool, stripeInvoiceId string, price float64, startDate time.Time, endDate time.Time, dueDate time.Time) *InvoiceDto {
	this := InvoiceDto{}
	this.Id = id
	this.Name = name
