...
func (o *KubernetesGetCrdListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewKubernetesGetCrdListTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewKubernetesGetCrdListTooManyRequests creates a KubernetesGetCrdListTooManyRequests with default headers values
func NewKubernetesGetCrdListTooManyRequests() *KubernetesGetCrdListTooManyRequests {
	return &KubernetesGetCrdListTooManyRequests{}
}

/* KubernetesGetCrdListTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type KubernetesGetCrdListTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *KubernetesGetCrdListTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /api/v{v}/Kubernetes/{projectId}/crd][%d] kubernetesGetCrdListTooManyRequests  %+v", 429, o.Payload)
}
func (o *KubernetesGetCrdListTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *KubernetesGetCrdListTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
