...
func (o *KubernetesSilenceManagerReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewKubernetesSilenceManagerTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewKubernetesSilenceManagerTooManyRequests creates a KubernetesSilenceManagerTooManyRequests with default headers values
func NewKubernetesSilenceManagerTooManyRequests() *KubernetesSilenceManagerTooManyRequests {
	return &KubernetesSilenceManagerTooManyRequests{}
}

/* KubernetesSilenceManagerTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type KubernetesSilenceManagerTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *KubernetesSilenceManagerTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Kubernetes/silencemanager][%d] kubernetesSilenceManagerTooManyRequests  %+v", 429, o.Payload)
}
func (o *KubernetesSilenceManagerTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *KubernetesSilenceManagerTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
