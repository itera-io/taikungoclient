...
func (o *KubernetesPatchPodOK) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Kubernetes/patch/pod][%d] kubernetesPatchPodOK ", 200)
}
...
func (o *KubernetesPatchPodBadRequest) GetPayload() interface{} {
	return o.Payload
}
...
func (o *KubernetesPatchPodUnauthorized) GetPayload() interface{} {
	return o.Payload
}
...
func (o *KubernetesPatchPodForbidden) GetPayload() interface{} {
	return o.Payload
}
...
func (o *KubernetesPatchPodNotFound) GetPayload() interface{} {
	return o.Payload
}
