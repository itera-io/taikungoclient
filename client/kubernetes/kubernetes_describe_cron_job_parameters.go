...
type KubernetesDescribeCronJobParams struct {
	...
	// Body.
	Body KubernetesDescribeCronJobBody
...
func (o *KubernetesDescribeCronJobParams) WithBody(body KubernetesDescribeCronJobBody) *KubernetesDescribeCronJobParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the kubernetes describe cron job params
func (o *KubernetesDescribeCronJobParams) SetBody(body KubernetesDescribeCronJobBody) {
	o.Body = body
}
