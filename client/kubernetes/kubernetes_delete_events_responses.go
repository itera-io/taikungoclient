...
func (o *KubernetesDeleteEventsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewKubernetesDeleteEventsTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewKubernetesDeleteEventsTooManyRequests creates a KubernetesDeleteEventsTooManyRequests with default headers values
func NewKubernetesDeleteEventsTooManyRequests() *KubernetesDeleteEventsTooManyRequests {
	return &KubernetesDeleteEventsTooManyRequests{}
}

/* KubernetesDeleteEventsTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type KubernetesDeleteEventsTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *KubernetesDeleteEventsTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Kubernetes/removeevents][%d] kubernetesDeleteEventsTooManyRequests  %+v", 429, o.Payload)
}
func (o *KubernetesDeleteEventsTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *KubernetesDeleteEventsTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
