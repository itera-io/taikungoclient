...
type KubernetesDescribeStorageClassParams struct {
	...
	// Body.
	Body KubernetesDescribeStorageClassBody
...
func (o *KubernetesDescribeStorageClassParams) WithBody(body KubernetesDescribeStorageClassBody) *KubernetesDescribeStorageClassParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the kubernetes describe storage class params
func (o *KubernetesDescribeStorageClassParams) SetBody(body KubernetesDescribeStorageClassBody) {
	o.Body = body
}
