...
func (o *KubernetesExecCliReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewKubernetesExecCliTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewKubernetesExecCliTooManyRequests creates a KubernetesExecCliTooManyRequests with default headers values
func NewKubernetesExecCliTooManyRequests() *KubernetesExecCliTooManyRequests {
	return &KubernetesExecCliTooManyRequests{}
}

/* KubernetesExecCliTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type KubernetesExecCliTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *KubernetesExecCliTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Kubernetes/cli][%d] kubernetesExecCliTooManyRequests  %+v", 429, o.Payload)
}
func (o *KubernetesExecCliTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *KubernetesExecCliTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
