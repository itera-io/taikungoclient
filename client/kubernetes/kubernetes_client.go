...
type ClientService interface {
	...
	KubernetesInteractiveShell(params *KubernetesInteractiveShellParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*KubernetesInteractiveShellOK, error)
...
/*
KubernetesInteractiveShell produces interactive shell command
*/
func (a *Client) KubernetesInteractiveShell(params *KubernetesInteractiveShellParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*KubernetesInteractiveShellOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewKubernetesInteractiveShellParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "Kubernetes_InteractiveShell",
		Method:             "POST",
		PathPattern:        "/api/v{v}/Kubernetes/interactive-shell",
		ProducesMediaTypes: []string{"application/json", "text/json", "text/plain"},
		ConsumesMediaTypes: []string{"application/*+json", "application/json", "application/json-patch+json", "text/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &KubernetesInteractiveShellReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*KubernetesInteractiveShellOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for Kubernetes_InteractiveShell: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
