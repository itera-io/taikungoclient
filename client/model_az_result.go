...
func (o *AzResult) UnmarshalJSON(data []byte) (err error) {
	...
	varAzResult := _AzResult{}

	err = json.Unmarshal(data, &varAzResult)

	if err != nil {
		return err
	}

	*o = AzResult(varAzResult)
