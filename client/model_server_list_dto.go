...
type ServerListDto struct {
	...
	ActionButtons NullableServerActionButtonVisibilityDto `json:"actionButtons,omitempty"`
...
// GetActionButtons returns the ActionButtons field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ServerListDto) GetActionButtons() ServerActionButtonVisibilityDto {
	if o == nil || IsNil(o.ActionButtons.Get()) {
...
func (o *ServerListDto) HasActionButtons() bool {
	if o != nil && o.ActionButtons.IsSet() {
		return true
	}
...
// SetActionButtons gets a reference to the given NullableServerActionButtonVisibilityDto and assigns it to the ActionButtons field.
func (o *ServerListDto) SetActionButtons(v ServerActionButtonVisibilityDto) {
	o.ActionButtons.Set(&v)
}
// SetActionButtonsNil sets the value for ActionButtons to be an explicit nil
func (o *ServerListDto) SetActionButtonsNil() {
	o.ActionButtons.Set(nil)
}

// UnsetActionButtons ensures that no value is present for ActionButtons, not even an explicit nil
func (o *ServerListDto) UnsetActionButtons() {
	o.ActionButtons.Unset()
}
