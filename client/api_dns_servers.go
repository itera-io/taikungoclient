...
func (r ApiDnsserversEditRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
func (a *DnsServersAPIService) DnsserversEditExecute(r ApiDnsserversEditRequest) (map[string]interface{}, *http.Response, error) {
	var (
