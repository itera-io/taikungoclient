...
func NewCreateSecurityGroupCommand(name string, protocol SecurityGroupProtocol, portMinRange int32, portMaxRange int32, remoteIpPrefix string, standAloneProfileId int32) *CreateSecurityGroupCommand {
