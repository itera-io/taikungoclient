...
func (r ApiImportedClusterListRequest) Id(id int32) ApiImportedClusterListRequest {
	r.id = &id
	return r
}

func (r ApiImportedClusterListRequest) Execute() (*ImportedClusterVClusterList, *http.Response, error) {
	return r.ApiService.ImportedClusterListExecute(r)
}

/*
ImportedClusterList Retrieve all vCluster(s) by given imported cluster

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param parentProjectId
 @return ApiImportedClusterListRequest
*/
func (a *ImportedClusterAPIService) ImportedClusterList(ctx context.Context, parentProjectId int32) ApiImportedClusterListRequest {
	return ApiImportedClusterListRequest{
		ApiService: a,
		ctx: ctx,
...
// Execute executes the request
//  @return ImportedClusterVClusterList
func (a *ImportedClusterAPIService) ImportedClusterListExecute(r ApiImportedClusterListRequest) (*ImportedClusterVClusterList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ImportedClusterVClusterList
	)
	...
	localVarPath := localBasePath + "/api/v1/imported-cluster/{parentProjectId}/virtual-clusters"
