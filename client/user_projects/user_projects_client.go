...
type ClientService interface {
	...
	UserProjectsProjectsListByUser(params *UserProjectsProjectsListByUserParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*UserProjectsProjectsListByUserOK, error)
...
func (a *Client) UserProjectsProjectsListByUser(params *UserProjectsProjectsListByUserParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*UserProjectsProjectsListByUserOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewUserProjectsProjectsListByUserParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "UserProjects_ProjectsListByUser",
		Method:             "GET",
		PathPattern:        "/api/v{v}/UserProjects/projects/list",
		ProducesMediaTypes: []string{"application/json", "text/json", "text/plain"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &UserProjectsProjectsListByUserReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*UserProjectsProjectsListByUserOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for UserProjects_ProjectsListByUser: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
