...
func NewStandAloneProfiles(data []StandAloneProfilesListDto, offset int32, limit int32, hasMore bool, totalCount int32) *StandAloneProfiles {
...
func (o *StandAloneProfiles) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varStandAloneProfiles)
