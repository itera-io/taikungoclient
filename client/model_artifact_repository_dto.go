...
func NewArtifactRepositoryDto(repositoryId NullableString, appRepoId int32, name string, displayName NullableString, url string, organizationName string, disabled bool, verifiedPublisher bool, official bool, isBound bool, isPrivate bool, isTaikun bool, hasCatalogApp bool, passwordProtected bool) *ArtifactRepositoryDto {
...
// GetPasswordProtected returns the PasswordProtected field value
...
// GetPasswordProtectedOk returns a tuple with the PasswordProtected field value
// and a boolean to check if the value has been set.
...
// SetPasswordProtected sets field value
