...
func (o *BackupClearProjectReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewBackupClearProjectTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewBackupClearProjectTooManyRequests creates a BackupClearProjectTooManyRequests with default headers values
func NewBackupClearProjectTooManyRequests() *BackupClearProjectTooManyRequests {
	return &BackupClearProjectTooManyRequests{}
}

/* BackupClearProjectTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type BackupClearProjectTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *BackupClearProjectTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Backup/clear/project][%d] backupClearProjectTooManyRequests  %+v", 429, o.Payload)
}
func (o *BackupClearProjectTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *BackupClearProjectTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
