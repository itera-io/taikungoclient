...
func (o *BackupDisableBackupReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewBackupDisableBackupTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewBackupDisableBackupTooManyRequests creates a BackupDisableBackupTooManyRequests with default headers values
func NewBackupDisableBackupTooManyRequests() *BackupDisableBackupTooManyRequests {
	return &BackupDisableBackupTooManyRequests{}
}

/* BackupDisableBackupTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type BackupDisableBackupTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *BackupDisableBackupTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Backup/disablebackup][%d] backupDisableBackupTooManyRequests  %+v", 429, o.Payload)
}
func (o *BackupDisableBackupTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *BackupDisableBackupTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
