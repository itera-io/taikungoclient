...
func (o *BackupListAllBackupsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewBackupListAllBackupsTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewBackupListAllBackupsTooManyRequests creates a BackupListAllBackupsTooManyRequests with default headers values
func NewBackupListAllBackupsTooManyRequests() *BackupListAllBackupsTooManyRequests {
	return &BackupListAllBackupsTooManyRequests{}
}

/* BackupListAllBackupsTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type BackupListAllBackupsTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *BackupListAllBackupsTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /api/v{v}/Backup/backups/{projectId}][%d] backupListAllBackupsTooManyRequests  %+v", 429, o.Payload)
}
func (o *BackupListAllBackupsTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *BackupListAllBackupsTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
