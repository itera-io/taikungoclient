...
func (o *BackupEnableBackupReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewBackupEnableBackupTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewBackupEnableBackupTooManyRequests creates a BackupEnableBackupTooManyRequests with default headers values
func NewBackupEnableBackupTooManyRequests() *BackupEnableBackupTooManyRequests {
	return &BackupEnableBackupTooManyRequests{}
}

/* BackupEnableBackupTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type BackupEnableBackupTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *BackupEnableBackupTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Backup/enablebackup][%d] backupEnableBackupTooManyRequests  %+v", 429, o.Payload)
}
func (o *BackupEnableBackupTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *BackupEnableBackupTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
