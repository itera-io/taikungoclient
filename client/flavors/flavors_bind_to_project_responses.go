...
func (o *FlavorsBindToProjectReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewFlavorsBindToProjectTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewFlavorsBindToProjectTooManyRequests creates a FlavorsBindToProjectTooManyRequests with default headers values
func NewFlavorsBindToProjectTooManyRequests() *FlavorsBindToProjectTooManyRequests {
	return &FlavorsBindToProjectTooManyRequests{}
}

/* FlavorsBindToProjectTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type FlavorsBindToProjectTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *FlavorsBindToProjectTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Flavors/bind][%d] flavorsBindToProjectTooManyRequests  %+v", 429, o.Payload)
}
func (o *FlavorsBindToProjectTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *FlavorsBindToProjectTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
