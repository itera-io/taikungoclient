...
func (o *FlavorsUnbindFromProjectReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewFlavorsUnbindFromProjectTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewFlavorsUnbindFromProjectTooManyRequests creates a FlavorsUnbindFromProjectTooManyRequests with default headers values
func NewFlavorsUnbindFromProjectTooManyRequests() *FlavorsUnbindFromProjectTooManyRequests {
	return &FlavorsUnbindFromProjectTooManyRequests{}
}

/* FlavorsUnbindFromProjectTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type FlavorsUnbindFromProjectTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *FlavorsUnbindFromProjectTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Flavors/unbind][%d] flavorsUnbindFromProjectTooManyRequests  %+v", 429, o.Payload)
}
func (o *FlavorsUnbindFromProjectTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *FlavorsUnbindFromProjectTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
