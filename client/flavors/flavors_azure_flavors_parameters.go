...
// WithOrganizationID adds the organizationID to the flavors azure flavors params
func (o *FlavorsAzureFlavorsParams) WithOrganizationID(organizationID *int32) *FlavorsAzureFlavorsParams {
	o.SetOrganizationID(organizationID)
	return o
}

// SetOrganizationID adds the organizationId to the flavors azure flavors params
func (o *FlavorsAzureFlavorsParams) SetOrganizationID(organizationID *int32) {
