...
func (o *FlavorsOpenstackFlavorsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewFlavorsOpenstackFlavorsTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewFlavorsOpenstackFlavorsTooManyRequests creates a FlavorsOpenstackFlavorsTooManyRequests with default headers values
func NewFlavorsOpenstackFlavorsTooManyRequests() *FlavorsOpenstackFlavorsTooManyRequests {
	return &FlavorsOpenstackFlavorsTooManyRequests{}
}

/* FlavorsOpenstackFlavorsTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type FlavorsOpenstackFlavorsTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *FlavorsOpenstackFlavorsTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /api/v{v}/Flavors/openstack/{cloudId}][%d] flavorsOpenstackFlavorsTooManyRequests  %+v", 429, o.Payload)
}
func (o *FlavorsOpenstackFlavorsTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *FlavorsOpenstackFlavorsTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
