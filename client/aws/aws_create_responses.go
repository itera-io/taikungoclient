...
func (o *AwsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewAwsCreateTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewAwsCreateTooManyRequests creates a AwsCreateTooManyRequests with default headers values
func NewAwsCreateTooManyRequests() *AwsCreateTooManyRequests {
	return &AwsCreateTooManyRequests{}
}

/* AwsCreateTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type AwsCreateTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *AwsCreateTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Aws/create][%d] awsCreateTooManyRequests  %+v", 429, o.Payload)
}
func (o *AwsCreateTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *AwsCreateTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
