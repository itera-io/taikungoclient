...
type ClientService interface {
	...
	AwsAwsValidateOwner(params *AwsAwsValidateOwnerParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*AwsAwsValidateOwnerOK, error)
...
/*
AwsAwsValidateOwner validates aws owner
*/
func (a *Client) AwsAwsValidateOwner(params *AwsAwsValidateOwnerParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*AwsAwsValidateOwnerOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewAwsAwsValidateOwnerParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "Aws_AwsValidateOwner",
		Method:             "POST",
		PathPattern:        "/api/v{v}/Aws/validate-owners",
		ProducesMediaTypes: []string{"application/json", "text/json", "text/plain"},
		ConsumesMediaTypes: []string{"application/*+json", "application/json", "application/json-patch+json", "text/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &AwsAwsValidateOwnerReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*AwsAwsValidateOwnerOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for Aws_AwsValidateOwner: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
