...
// Code gets the status code for the aws list o k response
func (o *AwsListOK) Code() int {
	return 200
}
...
// Code gets the status code for the aws list bad request response
func (o *AwsListBadRequest) Code() int {
	return 400
}
...
func (o *AwsListBadRequest) GetPayload() interface{} {
	return o.Payload
}
...
// Code gets the status code for the aws list unauthorized response
func (o *AwsListUnauthorized) Code() int {
	return 401
}
...
// Code gets the status code for the aws list forbidden response
func (o *AwsListForbidden) Code() int {
	return 403
}
...
// Code gets the status code for the aws list not found response
func (o *AwsListNotFound) Code() int {
	return 404
}
...
// Code gets the status code for the aws list internal server error response
func (o *AwsListInternalServerError) Code() int {
	return 500
}
