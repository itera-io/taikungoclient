...
func NewCrdSearchCommand(limit NullableInt32, offset NullableInt32, searchTerm string, includePublicImportedClusters NullableBool) *CrdSearchCommand {
...
func (o *CrdSearchCommand) UnmarshalJSON(data []byte) (err error) {
	...
	varCrdSearchCommand := _CrdSearchCommand{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCrdSearchCommand)

	if err != nil {
		return err
	}

	*o = CrdSearchCommand(varCrdSearchCommand)
