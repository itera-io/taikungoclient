...
func (o *NotificationsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewNotificationsListTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewNotificationsListTooManyRequests creates a NotificationsListTooManyRequests with default headers values
func NewNotificationsListTooManyRequests() *NotificationsListTooManyRequests {
	return &NotificationsListTooManyRequests{}
}

/* NotificationsListTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type NotificationsListTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *NotificationsListTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /api/v{v}/Notifications][%d] notificationsListTooManyRequests  %+v", 429, o.Payload)
}
func (o *NotificationsListTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *NotificationsListTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
