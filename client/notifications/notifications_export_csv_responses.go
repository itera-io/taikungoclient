...
func (o *NotificationsExportCsvReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewNotificationsExportCsvTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewNotificationsExportCsvTooManyRequests creates a NotificationsExportCsvTooManyRequests with default headers values
func NewNotificationsExportCsvTooManyRequests() *NotificationsExportCsvTooManyRequests {
	return &NotificationsExportCsvTooManyRequests{}
}

/* NotificationsExportCsvTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type NotificationsExportCsvTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *NotificationsExportCsvTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /api/v{v}/Notifications/download][%d] notificationsExportCsvTooManyRequests  %+v", 429, o.Payload)
}
func (o *NotificationsExportCsvTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *NotificationsExportCsvTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
