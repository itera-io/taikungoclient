...
func (o *AzureDashboardReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewAzureDashboardTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewAzureDashboardTooManyRequests creates a AzureDashboardTooManyRequests with default headers values
func NewAzureDashboardTooManyRequests() *AzureDashboardTooManyRequests {
	return &AzureDashboardTooManyRequests{}
}

/* AzureDashboardTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type AzureDashboardTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *AzureDashboardTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Azure/quota/list][%d] azureDashboardTooManyRequests  %+v", 429, o.Payload)
}
func (o *AzureDashboardTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *AzureDashboardTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
