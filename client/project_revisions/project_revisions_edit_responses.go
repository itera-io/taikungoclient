...
func (o *ProjectRevisionsEditOK) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/ProjectRevisions/update/{projectId}][%d] projectRevisionsEditOK ", 200)
}
...
func (o *ProjectRevisionsEditBadRequest) GetPayload() interface{} {
	return o.Payload
}
