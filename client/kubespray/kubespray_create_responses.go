...
func (o *KubesprayCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewKubesprayCreateTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewKubesprayCreateTooManyRequests creates a KubesprayCreateTooManyRequests with default headers values
func NewKubesprayCreateTooManyRequests() *KubesprayCreateTooManyRequests {
	return &KubesprayCreateTooManyRequests{}
}

/* KubesprayCreateTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type KubesprayCreateTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *KubesprayCreateTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Kubespray][%d] kubesprayCreateTooManyRequests  %+v", 429, o.Payload)
}
func (o *KubesprayCreateTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *KubesprayCreateTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
