...
func (o *KubesprayListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewKubesprayListTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewKubesprayListTooManyRequests creates a KubesprayListTooManyRequests with default headers values
func NewKubesprayListTooManyRequests() *KubesprayListTooManyRequests {
	return &KubesprayListTooManyRequests{}
}

/* KubesprayListTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type KubesprayListTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *KubesprayListTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /api/v{v}/Kubespray][%d] kubesprayListTooManyRequests  %+v", 429, o.Payload)
}
func (o *KubesprayListTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *KubesprayListTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
