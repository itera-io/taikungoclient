...
type ClientService interface {
	...
	AutoscalingSyncAutoscaling(params *AutoscalingSyncAutoscalingParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*AutoscalingSyncAutoscalingOK, error)
...
/*
AutoscalingSyncAutoscaling syncs autoscaling
*/
func (a *Client) AutoscalingSyncAutoscaling(params *AutoscalingSyncAutoscalingParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*AutoscalingSyncAutoscalingOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewAutoscalingSyncAutoscalingParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "Autoscaling_SyncAutoscaling",
		Method:             "POST",
		PathPattern:        "/api/v{v}/Autoscaling/sync",
		ProducesMediaTypes: []string{"application/json", "text/json", "text/plain"},
		ConsumesMediaTypes: []string{"application/*+json", "application/json", "application/json-patch+json", "text/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &AutoscalingSyncAutoscalingReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*AutoscalingSyncAutoscalingOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for Autoscaling_SyncAutoscaling: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
