...
func (r ApiOpscredentialsListByOrganizationIdRequest) Execute() ([]OperationCredentialsForOrganizationEntity2, *http.Response, error) {
...
// Execute executes the request
//  @return []OperationCredentialsForOrganizationEntity2
func (a *OperationCredentialsAPIService) OpscredentialsListByOrganizationIdExecute(r ApiOpscredentialsListByOrganizationIdRequest) ([]OperationCredentialsForOrganizationEntity2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []OperationCredentialsForOrganizationEntity2
	)
