...
func NewProjectQuotaListDto(serverCpu int64, serverRam float64, serverDiskSize float64, vmCpu int64, vmRam float64, vmVolumeSize float64, projectId int32, projectName string) *ProjectQuotaListDto {
