...
func NewDeploymentSearchCommand(limit NullableInt32, offset NullableInt32, searchTerm string, includePublicImportedClusters NullableBool) *DeploymentSearchCommand {
...
func (o *DeploymentSearchCommand) GetIncludePublicImportedClusters() bool {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *DeploymentSearchCommand) GetIncludePublicImportedClustersOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DeploymentSearchCommand) UnmarshalJSON(data []byte) (err error) {
	...
	varDeploymentSearchCommand := _DeploymentSearchCommand{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeploymentSearchCommand)

	if err != nil {
		return err
	}

	*o = DeploymentSearchCommand(varDeploymentSearchCommand)
