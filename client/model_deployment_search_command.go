...
func (o *DeploymentSearchCommand) HasIncludePublicImportedClusters() bool {
...
func (o *DeploymentSearchCommand) UnsetIncludePublicImportedClusters() {
...
func (o *DeploymentSearchCommand) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varDeploymentSearchCommand)
