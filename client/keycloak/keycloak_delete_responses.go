...
func (o *KeycloakDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewKeycloakDeleteTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewKeycloakDeleteTooManyRequests creates a KeycloakDeleteTooManyRequests with default headers values
func NewKeycloakDeleteTooManyRequests() *KeycloakDeleteTooManyRequests {
	return &KeycloakDeleteTooManyRequests{}
}

/* KeycloakDeleteTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type KeycloakDeleteTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *KeycloakDeleteTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Keycloak/delete][%d] keycloakDeleteTooManyRequests  %+v", 429, o.Payload)
}
func (o *KeycloakDeleteTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *KeycloakDeleteTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
