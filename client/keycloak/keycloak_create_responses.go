...
func (o *KeycloakCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewKeycloakCreateTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewKeycloakCreateTooManyRequests creates a KeycloakCreateTooManyRequests with default headers values
func NewKeycloakCreateTooManyRequests() *KeycloakCreateTooManyRequests {
	return &KeycloakCreateTooManyRequests{}
}

/* KeycloakCreateTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type KeycloakCreateTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *KeycloakCreateTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Keycloak/create][%d] keycloakCreateTooManyRequests  %+v", 429, o.Payload)
}
func (o *KeycloakCreateTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *KeycloakCreateTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
