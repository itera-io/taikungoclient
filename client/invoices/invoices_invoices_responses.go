...
func (o *InvoicesInvoicesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewInvoicesInvoicesTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewInvoicesInvoicesTooManyRequests creates a InvoicesInvoicesTooManyRequests with default headers values
func NewInvoicesInvoicesTooManyRequests() *InvoicesInvoicesTooManyRequests {
	return &InvoicesInvoicesTooManyRequests{}
}

/* InvoicesInvoicesTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type InvoicesInvoicesTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *InvoicesInvoicesTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /api/v{v}/Invoices/list][%d] invoicesInvoicesTooManyRequests  %+v", 429, o.Payload)
}
func (o *InvoicesInvoicesTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *InvoicesInvoicesTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
