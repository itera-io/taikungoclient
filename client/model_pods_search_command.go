...
func NewPodsSearchCommand(limit NullableInt32, offset NullableInt32, searchTerm string, includePublicImportedClusters NullableBool) *PodsSearchCommand {
...
func (o *PodsSearchCommand) GetIncludePublicImportedClusters() bool {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PodsSearchCommand) GetIncludePublicImportedClustersOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PodsSearchCommand) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varPodsSearchCommand)
