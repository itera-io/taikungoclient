...
func NewProjectsSearchCommand(limit NullableInt32, offset NullableInt32, searchTerm string) *ProjectsSearchCommand {
...
func (o *ProjectsSearchCommand) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varProjectsSearchCommand)
