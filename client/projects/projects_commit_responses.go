...
func (o *ProjectsCommitOK) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Projects/commit/{projectId}][%d] projectsCommitOK ", 200)
}
...
func (o *ProjectsCommitUnauthorized) GetPayload() interface{} {
	return o.Payload
}
...
func (o *ProjectsCommitForbidden) GetPayload() interface{} {
	return o.Payload
}
...
func (o *ProjectsCommitNotFound) GetPayload() interface{} {
	return o.Payload
}
