...
func (o *ProjectsListSelectorReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewProjectsListSelectorTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewProjectsListSelectorTooManyRequests creates a ProjectsListSelectorTooManyRequests with default headers values
func NewProjectsListSelectorTooManyRequests() *ProjectsListSelectorTooManyRequests {
	return &ProjectsListSelectorTooManyRequests{}
}

/* ProjectsListSelectorTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type ProjectsListSelectorTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *ProjectsListSelectorTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /api/v{v}/Projects/list][%d] projectsListSelectorTooManyRequests  %+v", 429, o.Payload)
}
func (o *ProjectsListSelectorTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *ProjectsListSelectorTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
