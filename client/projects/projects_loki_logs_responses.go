...
func (o *ProjectsLokiLogsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewProjectsLokiLogsTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewProjectsLokiLogsTooManyRequests creates a ProjectsLokiLogsTooManyRequests with default headers values
func NewProjectsLokiLogsTooManyRequests() *ProjectsLokiLogsTooManyRequests {
	return &ProjectsLokiLogsTooManyRequests{}
}

/* ProjectsLokiLogsTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type ProjectsLokiLogsTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *ProjectsLokiLogsTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Projects/lokilogs][%d] projectsLokiLogsTooManyRequests  %+v", 429, o.Payload)
}
func (o *ProjectsLokiLogsTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *ProjectsLokiLogsTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
