...
type ProjectsListBadRequest struct {
	Payload []*ProjectsListBadRequestBodyItems0
}
...
func (o *ProjectsListBadRequest) GetPayload() []*ProjectsListBadRequestBodyItems0 {
	return o.Payload
}
...
/*
ProjectsListBadRequestBodyItems0 projects list bad request body items0
swagger:model ProjectsListBadRequestBodyItems0
*/
type ProjectsListBadRequestBodyItems0 struct {
...
// Validate validates this projects list bad request body items0
func (o *ProjectsListBadRequestBodyItems0) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this projects list bad request body items0 based on context it is used
func (o *ProjectsListBadRequestBodyItems0) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *ProjectsListBadRequestBodyItems0) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
...
func (o *ProjectsListBadRequestBodyItems0) UnmarshalBinary(b []byte) error {
	var res ProjectsListBadRequestBodyItems0
...
type ProjectsListOKBodyDataItems0 struct {
	...
	// bound users
	BoundUsers []*ProjectsListOKBodyDataItems0BoundUsersItems0 `json:"boundUsers"`
...
func (o *ProjectsListOKBodyDataItems0) validateBoundUsers(formats strfmt.Registry) error {
...
// ContextValidate validate this projects list o k body data items0 based on the context it is used
...
func (o *ProjectsListOKBodyDataItems0) contextValidateBoundUsers(ctx context.Context, formats strfmt.Registry) error {
...
/*
ProjectsListOKBodyDataItems0BoundUsersItems0 projects list o k body data items0 bound users items0
swagger:model ProjectsListOKBodyDataItems0BoundUsersItems0
*/
type ProjectsListOKBodyDataItems0BoundUsersItems0 struct {
...
// Validate validates this projects list o k body data items0 bound users items0
func (o *ProjectsListOKBodyDataItems0BoundUsersItems0) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this projects list o k body data items0 bound users items0 based on context it is used
func (o *ProjectsListOKBodyDataItems0BoundUsersItems0) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *ProjectsListOKBodyDataItems0BoundUsersItems0) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *ProjectsListOKBodyDataItems0BoundUsersItems0) UnmarshalBinary(b []byte) error {
	var res ProjectsListOKBodyDataItems0BoundUsersItems0
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
