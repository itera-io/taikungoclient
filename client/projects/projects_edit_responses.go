...
func (o *ProjectsEditReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewProjectsEditTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewProjectsEditTooManyRequests creates a ProjectsEditTooManyRequests with default headers values
func NewProjectsEditTooManyRequests() *ProjectsEditTooManyRequests {
	return &ProjectsEditTooManyRequests{}
}

/* ProjectsEditTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type ProjectsEditTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *ProjectsEditTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Projects/update/{projectId}][%d] projectsEditTooManyRequests  %+v", 429, o.Payload)
}
func (o *ProjectsEditTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *ProjectsEditTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
