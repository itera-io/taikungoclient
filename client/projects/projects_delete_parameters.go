...
// WithBody adds the body to the projects delete params
func (o *ProjectsDeleteParams) WithBody(body ProjectsDeleteBody) *ProjectsDeleteParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the projects delete params
func (o *ProjectsDeleteParams) SetBody(body ProjectsDeleteBody) {
	o.Body = body
}

// WithV adds the v to the projects delete params
func (o *ProjectsDeleteParams) WithV(v string) *ProjectsDeleteParams {
	o.SetV(v)
	return o
}

// SetV adds the v to the projects delete params
func (o *ProjectsDeleteParams) SetV(v string) {
	o.V = v
}
