...
func (o *ProjectsDeleteParams) WithBody(body *models.DeleteProjectCommand) *ProjectsDeleteParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the projects delete params
func (o *ProjectsDeleteParams) SetBody(body *models.DeleteProjectCommand) {
	o.Body = body
}
