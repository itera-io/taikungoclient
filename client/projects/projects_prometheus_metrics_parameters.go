...
type ProjectsPrometheusMetricsParams struct {
	...
	// Body.
	Body ProjectsPrometheusMetricsBody
...
func (o *ProjectsPrometheusMetricsParams) WithBody(body ProjectsPrometheusMetricsBody) *ProjectsPrometheusMetricsParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the projects prometheus metrics params
func (o *ProjectsPrometheusMetricsParams) SetBody(body ProjectsPrometheusMetricsBody) {
	o.Body = body
}
