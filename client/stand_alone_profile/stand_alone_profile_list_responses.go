...
func (o *StandAloneProfileListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewStandAloneProfileListTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewStandAloneProfileListTooManyRequests creates a StandAloneProfileListTooManyRequests with default headers values
func NewStandAloneProfileListTooManyRequests() *StandAloneProfileListTooManyRequests {
	return &StandAloneProfileListTooManyRequests{}
}

/* StandAloneProfileListTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type StandAloneProfileListTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *StandAloneProfileListTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /api/v{v}/StandAloneProfile][%d] standAloneProfileListTooManyRequests  %+v", 429, o.Payload)
}
func (o *StandAloneProfileListTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *StandAloneProfileListTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
