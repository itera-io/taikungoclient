...
var _ MappedNullable = &CronjobsSearchCommand{}
...
// NewCronjobsSearchCommandWithDefaults instantiates a new CronjobsSearchCommand object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewCronjobsSearchCommandWithDefaults() *CronjobsSearchCommand {
	this := CronjobsSearchCommand{}
	return &this
}
...
func (o *CronjobsSearchCommand) UnsetSearchTerm() {
	o.SearchTerm.Unset()
}
...
func (o *CronjobsSearchCommand) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCronjobsSearchCommand)
...
type NullableCronjobsSearchCommand struct {
	value *CronjobsSearchCommand
	isSet bool
}

func (v NullableCronjobsSearchCommand) Get() *CronjobsSearchCommand {
	return v.value
}

func (v *NullableCronjobsSearchCommand) Set(val *CronjobsSearchCommand) {
	v.value = val
	v.isSet = true
}

func (v NullableCronjobsSearchCommand) IsSet() bool {
	return v.isSet
}

func (v *NullableCronjobsSearchCommand) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCronjobsSearchCommand(val *CronjobsSearchCommand) *NullableCronjobsSearchCommand {
	return &NullableCronjobsSearchCommand{value: val, isSet: true}
}

func (v NullableCronjobsSearchCommand) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCronjobsSearchCommand) UnmarshalJSON(src []byte) error {
	v.isSet = true
