...
type BoundFlavorsForProjectsListDto struct {
	...
	LocalDiskSize int32 `json:"localDiskSize"`
}
...
func NewBoundFlavorsForProjectsListDto(id int32, name string, cpu int32, ram float64, projectId NullableInt32, projectName string, maxDataDiskCount NullableInt32, existsLinuxSpotPrice bool, existsWindowsSpotPrice bool, linuxSpotPrice NullableString, linuxPrice NullableString, windowsSpotPrice NullableString, windowsPrice NullableString, cloudType CloudType, localDiskSize int32) *BoundFlavorsForProjectsListDto {
...
// GetLocalDiskSize returns the LocalDiskSize field value
...
// GetLocalDiskSizeOk returns a tuple with the LocalDiskSize field value
// and a boolean to check if the value has been set.
...
// SetLocalDiskSize sets field value
