...
func (r ApiNtpserversEditRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
func (a *NtpServersAPIService) NtpserversEditExecute(r ApiNtpserversEditRequest) (map[string]interface{}, *http.Response, error) {
	var (
