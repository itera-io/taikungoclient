...
func (o *AccessProfilesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewAccessProfilesCreateTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewAccessProfilesCreateTooManyRequests creates a AccessProfilesCreateTooManyRequests with default headers values
func NewAccessProfilesCreateTooManyRequests() *AccessProfilesCreateTooManyRequests {
	return &AccessProfilesCreateTooManyRequests{}
}

/* AccessProfilesCreateTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type AccessProfilesCreateTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *AccessProfilesCreateTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/AccessProfiles][%d] accessProfilesCreateTooManyRequests  %+v", 429, o.Payload)
}
func (o *AccessProfilesCreateTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *AccessProfilesCreateTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
