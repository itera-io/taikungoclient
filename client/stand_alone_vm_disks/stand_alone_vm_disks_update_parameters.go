...
type StandAloneVMDisksUpdateParams struct {
	...
	// Body.
	Body StandAloneVMDisksUpdateBody
...
func (o *StandAloneVMDisksUpdateParams) WithBody(body StandAloneVMDisksUpdateBody) *StandAloneVMDisksUpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the stand alone Vm disks update params
func (o *StandAloneVMDisksUpdateParams) SetBody(body StandAloneVMDisksUpdateBody) {
	o.Body = body
}
