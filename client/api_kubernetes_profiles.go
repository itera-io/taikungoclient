...
func (r ApiKubernetesprofilesLockManagerRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
func (a *KubernetesProfilesAPIService) KubernetesprofilesLockManagerExecute(r ApiKubernetesprofilesLockManagerRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	if r.kubernetesProfilesLockManagerCommand == nil {
		return localVarReturnValue, nil, reportError("kubernetesProfilesLockManagerCommand is required and must be specified")
	}
