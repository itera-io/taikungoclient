...
func NewResourcePresetDto(name string, cpu CpuLimitsDto, ram RamLimitsDto, ephemeralStorage EphemeralStorageLimitsDto, workloadResources WorkloadResourceLimitsDto) *ResourcePresetDto {
