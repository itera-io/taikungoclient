...
type _ZededaFlavorList ZededaFlavorList

// NewZededaFlavorList instantiates a new ZededaFlavorList object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewZededaFlavorList(data []ProxmoxFlavorData, totalCount int32) *ZededaFlavorList {
...
func (o *ZededaFlavorList) UnmarshalJSON(data []byte) (err error) {
	...
	varZededaFlavorList := _ZededaFlavorList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varZededaFlavorList)

	if err != nil {
		return err
	}

	*o = ZededaFlavorList(varZededaFlavorList)
