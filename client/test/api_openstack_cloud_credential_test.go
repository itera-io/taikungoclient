...
func Test_taikunshowback_OpenstackCloudCredentialAPIService(t *testing.T) {
	...
	t.Run("Test OpenstackCloudCredentialAPIService OpenstackStorageTypes", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.OpenstackCloudCredentialAPI.OpenstackStorageTypes(context.Background()).Execute()
