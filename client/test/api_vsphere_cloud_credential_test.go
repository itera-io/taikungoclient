...
func Test_taikuncore_VsphereCloudCredentialAPIService(t *testing.T) {
	...
	t.Run("Test VsphereCloudCredentialAPIService VsphereValidateVsphereHypervisors", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		httpRes, err := apiClient.VsphereCloudCredentialAPI.VsphereValidateVsphereHypervisors(context.Background()).Execute()
