...
func NewGetToken(token string, refreshTokenExpireTime time.Time) *GetToken {
	this := GetToken{}
	this.Token = token
...
// GetRefreshTokenExpireTime returns the RefreshTokenExpireTime field value
...
// GetRefreshTokenExpireTimeOk returns a tuple with the RefreshTokenExpireTime field value
// and a boolean to check if the value has been set.
...
// SetRefreshTokenExpireTime sets field value
