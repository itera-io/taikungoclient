...
func NewProjectsForBillingDto(id int32, name string, createdAt NullableTime, billingStartDate NullableTime, organizationName string, price float64, servers []ServersForBillingDto, standaloneVms []StandaloneVmsForBillingDto, billingEnabled bool) *ProjectsForBillingDto {
