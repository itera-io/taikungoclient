...
func (r ApiUsertokenBindUnbindRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
func (a *UserTokenAPIService) UsertokenBindUnbindExecute(r ApiUsertokenBindUnbindRequest) (map[string]interface{}, *http.Response, error) {
	var (
