...
type AdminUpdateUserPasswordParams struct {
	...
	// Body.
	Body AdminUpdateUserPasswordBody
...
func (o *AdminUpdateUserPasswordParams) WithBody(body AdminUpdateUserPasswordBody) *AdminUpdateUserPasswordParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the admin update user password params
func (o *AdminUpdateUserPasswordParams) SetBody(body AdminUpdateUserPasswordBody) {
	o.Body = body
}
