...
func NewSlackConfigurationList(data []SlackConfigurationDto, limit int32, hasMore bool, totalCount int64, offset int32) *SlackConfigurationList {
...
func (o *SlackConfigurationList) GetLimit() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SlackConfigurationList) GetLimitOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Limit, true
...
func (o *SlackConfigurationList) SetLimit(v int32) {
	o.Limit = v
}

// GetHasMore returns the HasMore field value
func (o *SlackConfigurationList) GetHasMore() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SlackConfigurationList) GetHasMoreOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SlackConfigurationList) SetHasMore(v bool) {
	o.HasMore = v
}

// GetTotalCount returns the TotalCount field value
func (o *SlackConfigurationList) GetTotalCount() int64 {
	if o == nil {
		var ret int64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SlackConfigurationList) GetTotalCountOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SlackConfigurationList) SetTotalCount(v int64) {
	o.TotalCount = v
}

// GetOffset returns the Offset field value
func (o *SlackConfigurationList) GetOffset() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SlackConfigurationList) GetOffsetOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *SlackConfigurationList) GetNextOffsetOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SlackConfigurationList) HasNextOffset() bool {
