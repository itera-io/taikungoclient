...
```go
import taikunshowback "github.com/GIT_USER_ID/GIT_REPO_ID"
```
...
```go
auth := context.WithValue(context.Background(), taikunshowback.ContextBasicAuth, taikunshowback.BasicAuth{
	UserName: "username",
	Password: "password",
})
r, err := client.Service.Operation(auth, args)
