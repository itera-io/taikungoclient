...
*AdminAPI* | [**AdminUnlock2fa**](docs/AdminAPI.md#adminunlock2fa) | **Post** /api/v1/admin/users/{id}/unlock-2fa | Unlock 2FA
...
*UsersAPI* | [**UsersDeleteUserProjects**](docs/UsersAPI.md#usersdeleteuserprojects) | **Put** /api/v1/users/{id}/projects | Remove projects from user
