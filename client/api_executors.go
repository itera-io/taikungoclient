...
func (r ApiExecutorsEditHealthRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return map[string]interface{}
func (a *ExecutorsAPIService) ExecutorsEditHealthExecute(r ApiExecutorsEditHealthRequest) (map[string]interface{}, *http.Response, error) {
	var (
