...
func (r ApiSseHealthRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.SseHealthExecute(r)
}
...
func (a *SseAPIService) SseHealthExecute(r ApiSseHealthRequest) (map[string]interface{}, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/sse/health"
...
func (r ApiSseNotificationsRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.SseNotificationsExecute(r)
}
...
func (a *SseAPIService) SseNotificationsExecute(r ApiSseNotificationsRequest) (map[string]interface{}, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/sse/notifications"
...
type ApiSseRecentEventsRequest struct {
	ctx context.Context
	ApiService *SseAPIService
...
func (r ApiSseRecentEventsRequest) Status(status ActionStatus) ApiSseRecentEventsRequest {
	r.status = &status
	return r
}

func (r ApiSseRecentEventsRequest) Category(category ActionType) ApiSseRecentEventsRequest {
	r.category = &category
	return r
}

func (r ApiSseRecentEventsRequest) ProjectId(projectId int32) ApiSseRecentEventsRequest {
	r.projectId = &projectId
	return r
}

func (r ApiSseRecentEventsRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.SseRecentEventsExecute(r)
}

/*
SseRecentEvents Subscribe to real-time audit log events

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param organizationId
 @return ApiSseRecentEventsRequest
*/
func (a *SseAPIService) SseRecentEvents(ctx context.Context, organizationId int32) ApiSseRecentEventsRequest {
	return ApiSseRecentEventsRequest{
		ApiService: a,
		ctx: ctx,
...
// Execute executes the request
//  @return map[string]interface{}
func (a *SseAPIService) SseRecentEventsExecute(r ApiSseRecentEventsRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SseAPIService.SseRecentEvents")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/sse/recent-events/{organizationId}"
...
func (r ApiSseUpdateUserPermissionRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.SseUpdateUserPermissionExecute(r)
}
...
func (a *SseAPIService) SseUpdateUserPermissionExecute(r ApiSseUpdateUserPermissionRequest) (map[string]interface{}, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/sse/update-user-permission"
