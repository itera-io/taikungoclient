...
func (o *ServersCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewServersCreateTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewServersCreateTooManyRequests creates a ServersCreateTooManyRequests with default headers values
func NewServersCreateTooManyRequests() *ServersCreateTooManyRequests {
	return &ServersCreateTooManyRequests{}
}

/* ServersCreateTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type ServersCreateTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *ServersCreateTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Servers][%d] serversCreateTooManyRequests  %+v", 429, o.Payload)
}
func (o *ServersCreateTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *ServersCreateTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
