...
func (o *BillingCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewBillingCreateTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewBillingCreateTooManyRequests creates a BillingCreateTooManyRequests with default headers values
func NewBillingCreateTooManyRequests() *BillingCreateTooManyRequests {
	return &BillingCreateTooManyRequests{}
}

/* BillingCreateTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type BillingCreateTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *BillingCreateTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Billing/add][%d] billingCreateTooManyRequests  %+v", 429, o.Payload)
}
func (o *BillingCreateTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *BillingCreateTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
