...
func (o *CreateOpenstackCloudCommand) HasManilaEnabled() bool {
	if o != nil && !IsNil(o.ManilaEnabled) {
		return true
	}
...
func (o *CreateOpenstackCloudCommand) UnsetManilaStorageType() {
...
func (o *CreateOpenstackCloudCommand) UnmarshalJSON(data []byte) (err error) {
	...
	*o = CreateOpenstackCloudCommand(varCreateOpenstackCloudCommand)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "lbProvider")
