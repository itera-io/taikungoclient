...
func NewSecretSearchCommand(limit NullableInt32, offset NullableInt32, searchTerm string, includePublicImportedClusters NullableBool) *SecretSearchCommand {
...
func (o *SecretSearchCommand) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varSecretSearchCommand)
