...
type _SecretSearchCommand SecretSearchCommand
...
func (o *SecretSearchCommand) GetIncludePublicImportedClusters() bool {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *SecretSearchCommand) GetIncludePublicImportedClustersOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SecretSearchCommand) HasIncludePublicImportedClusters() bool {
...
func (o *SecretSearchCommand) SetIncludePublicImportedClusters(v bool) {
...
func (o *SecretSearchCommand) SetIncludePublicImportedClustersNil() {
...
func (o *SecretSearchCommand) UnsetIncludePublicImportedClusters() {
...
func (o *SecretSearchCommand) UnmarshalJSON(data []byte) (err error) {
	varSecretSearchCommand := _SecretSearchCommand{}

	err = json.Unmarshal(data, &varSecretSearchCommand)

	if err != nil {
		return err
	}

	*o = SecretSearchCommand(varSecretSearchCommand)
