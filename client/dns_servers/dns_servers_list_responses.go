...
// Code gets the status code for the dns servers list o k response
func (o *DNSServersListOK) Code() int {
	return 200
}
...
// Code gets the status code for the dns servers list bad request response
func (o *DNSServersListBadRequest) Code() int {
	return 400
}
...
// Code gets the status code for the dns servers list unauthorized response
func (o *DNSServersListUnauthorized) Code() int {
	return 401
}
...
// Code gets the status code for the dns servers list forbidden response
func (o *DNSServersListForbidden) Code() int {
	return 403
}
...
// Code gets the status code for the dns servers list not found response
func (o *DNSServersListNotFound) Code() int {
	return 404
}
...
// Code gets the status code for the dns servers list internal server error response
func (o *DNSServersListInternalServerError) Code() int {
	return 500
}
