...
type ApiCronJobScanCertificateCredentialExpiryLegacyRequest struct {
	ctx context.Context
	ApiService *CronJobServiceAPIService
	body *map[string]interface{}
}

func (r ApiCronJobScanCertificateCredentialExpiryLegacyRequest) Body(body map[string]interface{}) ApiCronJobScanCertificateCredentialExpiryLegacyRequest {
	r.body = &body
	return r
}

func (r ApiCronJobScanCertificateCredentialExpiryLegacyRequest) Execute() (*http.Response, error) {
	return r.ApiService.CronJobScanCertificateCredentialExpiryLegacyExecute(r)
}

/*
CronJobScanCertificateCredentialExpiryLegacy Legacy alias for scan-certificate-profile-expiry (pre-rename cron path)

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiCronJobScanCertificateCredentialExpiryLegacyRequest
*/
func (a *CronJobServiceAPIService) CronJobScanCertificateCredentialExpiryLegacy(ctx context.Context) ApiCronJobScanCertificateCredentialExpiryLegacyRequest {
	return ApiCronJobScanCertificateCredentialExpiryLegacyRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *CronJobServiceAPIService) CronJobScanCertificateCredentialExpiryLegacyExecute(r ApiCronJobScanCertificateCredentialExpiryLegacyRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CronJobServiceAPIService.CronJobScanCertificateCredentialExpiryLegacy")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/cronjob/scan-certificate-credential-expiry"
...
type ApiCronJobScanCertificateProfileExpiryRequest struct {
	ctx context.Context
	ApiService *CronJobServiceAPIService
	body *map[string]interface{}
}

func (r ApiCronJobScanCertificateProfileExpiryRequest) Body(body map[string]interface{}) ApiCronJobScanCertificateProfileExpiryRequest {
	r.body = &body
	return r
}

func (r ApiCronJobScanCertificateProfileExpiryRequest) Execute() (*http.Response, error) {
	return r.ApiService.CronJobScanCertificateProfileExpiryExecute(r)
}

/*
CronJobScanCertificateProfileExpiry Scan certificate profiles approaching or past expiry and emit alert logs

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiCronJobScanCertificateProfileExpiryRequest
*/
func (a *CronJobServiceAPIService) CronJobScanCertificateProfileExpiry(ctx context.Context) ApiCronJobScanCertificateProfileExpiryRequest {
	return ApiCronJobScanCertificateProfileExpiryRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *CronJobServiceAPIService) CronJobScanCertificateProfileExpiryExecute(r ApiCronJobScanCertificateProfileExpiryRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CronJobServiceAPIService.CronJobScanCertificateProfileExpiry")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/cronjob/scan-certificate-profile-expiry"
...
type ApiCronjobCcfCryptoStatusRequest struct {
	ctx context.Context
	ApiService *CronJobServiceAPIService
}

func (r ApiCronjobCcfCryptoStatusRequest) Execute() (*TransitEncryptionStatusDto, *http.Response, error) {
	return r.ApiService.CronjobCcfCryptoStatusExecute(r)
}

/*
CronjobCcfCryptoStatus Rollback-safety survey: per-column $enc:v1: row counts and last Transit failure timestamp

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiCronjobCcfCryptoStatusRequest
*/
func (a *CronJobServiceAPIService) CronjobCcfCryptoStatus(ctx context.Context) ApiCronjobCcfCryptoStatusRequest {
	return ApiCronjobCcfCryptoStatusRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return TransitEncryptionStatusDto
func (a *CronJobServiceAPIService) CronjobCcfCryptoStatusExecute(r ApiCronjobCcfCryptoStatusRequest) (*TransitEncryptionStatusDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *TransitEncryptionStatusDto
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CronJobServiceAPIService.CronjobCcfCryptoStatus")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/cronjob/ccf-crypto/status"
...
type ApiCronjobReconcilePartnerScopesRequest struct {
	ctx context.Context
	ApiService *CronJobServiceAPIService
}

func (r ApiCronjobReconcilePartnerScopesRequest) Execute() (*PartnerScopeReconcileResult, *http.Response, error) {
	return r.ApiService.CronjobReconcilePartnerScopesExecute(r)
}

/*
CronjobReconcilePartnerScopes Reconcile CCF partner scope holders (moves DEK rows off soft-deleted partner scope holders)

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiCronjobReconcilePartnerScopesRequest
*/
func (a *CronJobServiceAPIService) CronjobReconcilePartnerScopes(ctx context.Context) ApiCronjobReconcilePartnerScopesRequest {
	return ApiCronjobReconcilePartnerScopesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return PartnerScopeReconcileResult
func (a *CronJobServiceAPIService) CronjobReconcilePartnerScopesExecute(r ApiCronjobReconcilePartnerScopesRequest) (*PartnerScopeReconcileResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PartnerScopeReconcileResult
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CronJobServiceAPIService.CronjobReconcilePartnerScopes")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/cronjob/reconcile-partner-scopes"
...
type ApiCronjobRotateTenantKeksRequest struct {
	ctx context.Context
	ApiService *CronJobServiceAPIService
	rotateTenantKeksCommand *RotateTenantKeksCommand
}

func (r ApiCronjobRotateTenantKeksRequest) RotateTenantKeksCommand(rotateTenantKeksCommand RotateTenantKeksCommand) ApiCronjobRotateTenantKeksRequest {
	r.rotateTenantKeksCommand = &rotateTenantKeksCommand
	return r
}

func (r ApiCronjobRotateTenantKeksRequest) Execute() (*http.Response, error) {
	return r.ApiService.CronjobRotateTenantKeksExecute(r)
}

/*
CronjobRotateTenantKeks Rotate tenant KEKs via Transit rewrap

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiCronjobRotateTenantKeksRequest
*/
func (a *CronJobServiceAPIService) CronjobRotateTenantKeks(ctx context.Context) ApiCronjobRotateTenantKeksRequest {
	return ApiCronjobRotateTenantKeksRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *CronJobServiceAPIService) CronjobRotateTenantKeksExecute(r ApiCronjobRotateTenantKeksRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CronJobServiceAPIService.CronjobRotateTenantKeks")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/cronjob/rotate-tenant-keks"
	...
	// body params
	localVarPostBody = r.rotateTenantKeksCommand
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["Bearer"]; ok {
...
type ApiCronjobSyncDnsCertConfigsRequest struct {
	ctx context.Context
	ApiService *CronJobServiceAPIService
	body *map[string]interface{}
}

func (r ApiCronjobSyncDnsCertConfigsRequest) Body(body map[string]interface{}) ApiCronjobSyncDnsCertConfigsRequest {
	r.body = &body
	return r
}

func (r ApiCronjobSyncDnsCertConfigsRequest) Execute() (*http.Response, error) {
	return r.ApiService.CronjobSyncDnsCertConfigsExecute(r)
}

/*
CronjobSyncDnsCertConfigs Sync DNS/Cert configs (drift cron — re-fires kubevap addons pipeline when Applied < Desired)

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiCronjobSyncDnsCertConfigsRequest
*/
func (a *CronJobServiceAPIService) CronjobSyncDnsCertConfigs(ctx context.Context) ApiCronjobSyncDnsCertConfigsRequest {
	return ApiCronjobSyncDnsCertConfigsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *CronJobServiceAPIService) CronjobSyncDnsCertConfigsExecute(r ApiCronjobSyncDnsCertConfigsRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CronJobServiceAPIService.CronjobSyncDnsCertConfigs")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/cronjob/sync-dns-cert-configs"
