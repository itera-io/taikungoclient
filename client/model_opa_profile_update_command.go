...
func NewOpaProfileUpdateCommand(id int32, name string, allowedRepo []string, forbidSpecificTags []string, ingressWhitelist []string, whitelistMasterTaintNamespaces []string) *OpaProfileUpdateCommand {
