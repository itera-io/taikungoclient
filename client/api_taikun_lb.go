...
func (r ApiTaikunLbCreateTaikunLbRequest) Execute() (*TaikunLbResponseDto, *http.Response, error) {
...
func (r ApiTaikunLbDeleteTaikunLbRequest) CreateGenericTaikunLbDto(createGenericTaikunLbDto CreateGenericTaikunLbDto) ApiTaikunLbDeleteTaikunLbRequest {
	r.createGenericTaikunLbDto = &createGenericTaikunLbDto
	return r
}

func (r ApiTaikunLbDeleteTaikunLbRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.TaikunLbDeleteTaikunLbExecute(r)
}
...
func (a *TaikunLBAPIService) TaikunLbDeleteTaikunLbExecute(r ApiTaikunLbDeleteTaikunLbRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localVarPath := localBasePath + "/api/v1/taikun-lb/delete/{projectId}"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterValueToString(r.projectId, "projectId")), -1)
...
func (r ApiTaikunLbListTaikunLbRequest) SvcName(svcName string) ApiTaikunLbListTaikunLbRequest {
	r.svcName = &svcName
	return r
}

func (r ApiTaikunLbListTaikunLbRequest) SvcNameSpace(svcNameSpace string) ApiTaikunLbListTaikunLbRequest {
	r.svcNameSpace = &svcNameSpace
	return r
}
...
func (a *TaikunLBAPIService) TaikunLbListTaikunLbExecute(r ApiTaikunLbListTaikunLbRequest) ([]TaikunLbResponseDto, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/taikun-lb/list/{projectId}"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterValueToString(r.projectId, "projectId")), -1)
