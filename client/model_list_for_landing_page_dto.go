...
func NewListForLandingPageDto(id int32, name string, projectLimit int32, serverLimit int32, userLimit int32, cloudCredentialLimit int32, monthlyPrice float64, yearlyPrice float64, tcuPrice float64, isDeprecated bool, currency string, partnerId NullableInt32, trialDays int32, description string, isFree bool, isEnterprise bool) *ListForLandingPageDto {
