...
func NewProjectsList(data []ProjectListDetailDto, limit int32, hasMore bool, totalCount int64, offset int32) *ProjectsList {
	this := ProjectsList{}
	this.Data = data
	this.Limit = limit
...
func (o *ProjectsList) GetLimit() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ProjectsList) GetLimitOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Limit, true
...
func (o *ProjectsList) SetLimit(v int32) {
	o.Limit = v
}

// GetHasMore returns the HasMore field value
func (o *ProjectsList) GetHasMore() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ProjectsList) GetHasMoreOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ProjectsList) SetHasMore(v bool) {
	o.HasMore = v
}

// GetTotalCount returns the TotalCount field value
func (o *ProjectsList) GetTotalCount() int64 {
	if o == nil {
		var ret int64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ProjectsList) GetTotalCountOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ProjectsList) SetTotalCount(v int64) {
	o.TotalCount = v
}

// GetOffset returns the Offset field value
func (o *ProjectsList) GetOffset() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ProjectsList) GetOffsetOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ProjectsList) GetNextOffsetOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ProjectsList) HasNextOffset() bool {
...
func (o *ProjectsList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varProjectsList)
