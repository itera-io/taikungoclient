...
func (r ApiNotificationsCreateRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
func (a *NotificationsAPIService) NotificationsCreateExecute(r ApiNotificationsCreateRequest) (map[string]interface{}, *http.Response, error) {
	var (
...
func (r ApiNotificationsNotifyOwnerRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return map[string]interface{}
func (a *NotificationsAPIService) NotificationsNotifyOwnerExecute(r ApiNotificationsNotifyOwnerRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	if r.notifyOwnersCommand == nil {
		return localVarReturnValue, nil, reportError("notifyOwnersCommand is required and must be specified")
	}
