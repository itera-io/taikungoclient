...
func NewCatalogAppDetailsDto(id int32, appRepoId int32, catalogId int32, stars int32, verifiedPublisher bool, official bool, hasJsonSchema bool) *CatalogAppDetailsDto {
