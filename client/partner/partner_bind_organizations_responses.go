...
func (o *PartnerBindOrganizationsOK) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Partner/bindorganizations][%d] partnerBindOrganizationsOK ", 200)
}
...
func (o *PartnerBindOrganizationsBadRequest) GetPayload() interface{} {
	return o.Payload
}
