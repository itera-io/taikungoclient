...
func (o *PartnerBindOrganizationsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewPartnerBindOrganizationsTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewPartnerBindOrganizationsTooManyRequests creates a PartnerBindOrganizationsTooManyRequests with default headers values
func NewPartnerBindOrganizationsTooManyRequests() *PartnerBindOrganizationsTooManyRequests {
	return &PartnerBindOrganizationsTooManyRequests{}
}

/* PartnerBindOrganizationsTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type PartnerBindOrganizationsTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *PartnerBindOrganizationsTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Partner/bindorganizations][%d] partnerBindOrganizationsTooManyRequests  %+v", 429, o.Payload)
}
func (o *PartnerBindOrganizationsTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *PartnerBindOrganizationsTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
