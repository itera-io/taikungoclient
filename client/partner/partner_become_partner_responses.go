...
func (o *PartnerBecomePartnerReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewPartnerBecomePartnerTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewPartnerBecomePartnerTooManyRequests creates a PartnerBecomePartnerTooManyRequests with default headers values
func NewPartnerBecomePartnerTooManyRequests() *PartnerBecomePartnerTooManyRequests {
	return &PartnerBecomePartnerTooManyRequests{}
}

/* PartnerBecomePartnerTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type PartnerBecomePartnerTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *PartnerBecomePartnerTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Partner/become-a-partner][%d] partnerBecomePartnerTooManyRequests  %+v", 429, o.Payload)
}
func (o *PartnerBecomePartnerTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *PartnerBecomePartnerTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
