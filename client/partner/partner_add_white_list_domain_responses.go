...
func (o *PartnerAddWhiteListDomainReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewPartnerAddWhiteListDomainTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewPartnerAddWhiteListDomainTooManyRequests creates a PartnerAddWhiteListDomainTooManyRequests with default headers values
func NewPartnerAddWhiteListDomainTooManyRequests() *PartnerAddWhiteListDomainTooManyRequests {
	return &PartnerAddWhiteListDomainTooManyRequests{}
}

/* PartnerAddWhiteListDomainTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type PartnerAddWhiteListDomainTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *PartnerAddWhiteListDomainTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Partner/add/whitelist/domain][%d] partnerAddWhiteListDomainTooManyRequests  %+v", 429, o.Payload)
}
func (o *PartnerAddWhiteListDomainTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *PartnerAddWhiteListDomainTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
