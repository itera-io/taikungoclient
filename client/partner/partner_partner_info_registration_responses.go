...
func (o *PartnerPartnerInfoRegistrationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewPartnerPartnerInfoRegistrationTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewPartnerPartnerInfoRegistrationTooManyRequests creates a PartnerPartnerInfoRegistrationTooManyRequests with default headers values
func NewPartnerPartnerInfoRegistrationTooManyRequests() *PartnerPartnerInfoRegistrationTooManyRequests {
	return &PartnerPartnerInfoRegistrationTooManyRequests{}
}

/* PartnerPartnerInfoRegistrationTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type PartnerPartnerInfoRegistrationTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *PartnerPartnerInfoRegistrationTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /api/v{v}/Partner/info][%d] partnerPartnerInfoRegistrationTooManyRequests  %+v", 429, o.Payload)
}
func (o *PartnerPartnerInfoRegistrationTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *PartnerPartnerInfoRegistrationTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
