...
func (o *SearchBackupCredentialsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewSearchBackupCredentialsListTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewSearchBackupCredentialsListTooManyRequests creates a SearchBackupCredentialsListTooManyRequests with default headers values
func NewSearchBackupCredentialsListTooManyRequests() *SearchBackupCredentialsListTooManyRequests {
	return &SearchBackupCredentialsListTooManyRequests{}
}

/* SearchBackupCredentialsListTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type SearchBackupCredentialsListTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *SearchBackupCredentialsListTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Search/backup-credentials][%d] searchBackupCredentialsListTooManyRequests  %+v", 429, o.Payload)
}
func (o *SearchBackupCredentialsListTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *SearchBackupCredentialsListTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
