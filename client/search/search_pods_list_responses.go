...
func (o *SearchPodsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewSearchPodsListTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewSearchPodsListTooManyRequests creates a SearchPodsListTooManyRequests with default headers values
func NewSearchPodsListTooManyRequests() *SearchPodsListTooManyRequests {
	return &SearchPodsListTooManyRequests{}
}

/* SearchPodsListTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type SearchPodsListTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *SearchPodsListTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Search/pods][%d] searchPodsListTooManyRequests  %+v", 429, o.Payload)
}
func (o *SearchPodsListTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *SearchPodsListTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
