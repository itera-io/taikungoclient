...
func (o *SearchPrometheusRulesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewSearchPrometheusRulesListTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewSearchPrometheusRulesListTooManyRequests creates a SearchPrometheusRulesListTooManyRequests with default headers values
func NewSearchPrometheusRulesListTooManyRequests() *SearchPrometheusRulesListTooManyRequests {
	return &SearchPrometheusRulesListTooManyRequests{}
}

/* SearchPrometheusRulesListTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type SearchPrometheusRulesListTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *SearchPrometheusRulesListTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Search/prometheus-rules][%d] searchPrometheusRulesListTooManyRequests  %+v", 429, o.Payload)
}
func (o *SearchPrometheusRulesListTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *SearchPrometheusRulesListTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
