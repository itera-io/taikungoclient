...
func (o *SearchPersistenceVolumeClaimListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewSearchPersistenceVolumeClaimListTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewSearchPersistenceVolumeClaimListTooManyRequests creates a SearchPersistenceVolumeClaimListTooManyRequests with default headers values
func NewSearchPersistenceVolumeClaimListTooManyRequests() *SearchPersistenceVolumeClaimListTooManyRequests {
	return &SearchPersistenceVolumeClaimListTooManyRequests{}
}

/* SearchPersistenceVolumeClaimListTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type SearchPersistenceVolumeClaimListTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *SearchPersistenceVolumeClaimListTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Search/pvcs][%d] searchPersistenceVolumeClaimListTooManyRequests  %+v", 429, o.Payload)
}
func (o *SearchPersistenceVolumeClaimListTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *SearchPersistenceVolumeClaimListTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
