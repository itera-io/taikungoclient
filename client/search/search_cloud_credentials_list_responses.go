...
func (o *SearchCloudCredentialsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewSearchCloudCredentialsListTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewSearchCloudCredentialsListTooManyRequests creates a SearchCloudCredentialsListTooManyRequests with default headers values
func NewSearchCloudCredentialsListTooManyRequests() *SearchCloudCredentialsListTooManyRequests {
	return &SearchCloudCredentialsListTooManyRequests{}
}

/* SearchCloudCredentialsListTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type SearchCloudCredentialsListTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *SearchCloudCredentialsListTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Search/cloud-credentials][%d] searchCloudCredentialsListTooManyRequests  %+v", 429, o.Payload)
}
func (o *SearchCloudCredentialsListTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *SearchCloudCredentialsListTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
