...
func (o *SearchBillingCredentialsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewSearchBillingCredentialsListTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewSearchBillingCredentialsListTooManyRequests creates a SearchBillingCredentialsListTooManyRequests with default headers values
func NewSearchBillingCredentialsListTooManyRequests() *SearchBillingCredentialsListTooManyRequests {
	return &SearchBillingCredentialsListTooManyRequests{}
}

/* SearchBillingCredentialsListTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type SearchBillingCredentialsListTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *SearchBillingCredentialsListTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Search/billing-credentials][%d] searchBillingCredentialsListTooManyRequests  %+v", 429, o.Payload)
}
func (o *SearchBillingCredentialsListTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *SearchBillingCredentialsListTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
