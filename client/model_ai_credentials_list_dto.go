...
func NewAiCredentialsListDto(id int32, url string, name string, type_ AiType, organizationId NullableInt32, organizationName string, projects []CommonDropdownDto, isDefault bool) *AiCredentialsListDto {
