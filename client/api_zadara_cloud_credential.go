...
func (r ApiZadaraUpdateRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
func (a *ZadaraCloudCredentialAPIService) ZadaraUpdateExecute(r ApiZadaraUpdateRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
