...
func (r ApiBillingCreateRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
func (a *BillingAPIService) BillingCreateExecute(r ApiBillingCreateRequest) (map[string]interface{}, *http.Response, error) {
	var (
