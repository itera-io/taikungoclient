...
func (o *ServiceSearchCommand) HasIncludePublicImportedClusters() bool {
...
func (o *ServiceSearchCommand) UnsetIncludePublicImportedClusters() {
...
func (o *ServiceSearchCommand) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varServiceSearchCommand)
