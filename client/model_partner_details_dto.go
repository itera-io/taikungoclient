...
type PartnerDetailsDto struct {
	...
	PartnerColorSettings NullablePartnerColorSettingsDto `json:"partnerColorSettings,omitempty"`
	PartnerImageSettings NullablePartnerImageSettingsDto `json:"partnerImageSettings,omitempty"`
}
...
// GetPartnerColorSettings returns the PartnerColorSettings field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *PartnerDetailsDto) GetPartnerColorSettings() PartnerColorSettingsDto {
	if o == nil || IsNil(o.PartnerColorSettings.Get()) {
		var ret PartnerColorSettingsDto
		return ret
	}
	return *o.PartnerColorSettings.Get()
}
...
// SetPartnerColorSettings gets a reference to the given NullablePartnerColorSettingsDto and assigns it to the PartnerColorSettings field.
func (o *PartnerDetailsDto) SetPartnerColorSettings(v PartnerColorSettingsDto) {
	o.PartnerColorSettings.Set(&v)
}
// SetPartnerColorSettingsNil sets the value for PartnerColorSettings to be an explicit nil
func (o *PartnerDetailsDto) SetPartnerColorSettingsNil() {
	o.PartnerColorSettings.Set(nil)
}

// UnsetPartnerColorSettings ensures that no value is present for PartnerColorSettings, not even an explicit nil
func (o *PartnerDetailsDto) UnsetPartnerColorSettings() {
	o.PartnerColorSettings.Unset()
}

// GetPartnerImageSettings returns the PartnerImageSettings field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *PartnerDetailsDto) GetPartnerImageSettings() PartnerImageSettingsDto {
	if o == nil || IsNil(o.PartnerImageSettings.Get()) {
		var ret PartnerImageSettingsDto
		return ret
	}
	return *o.PartnerImageSettings.Get()
}
...
// SetPartnerImageSettings gets a reference to the given NullablePartnerImageSettingsDto and assigns it to the PartnerImageSettings field.
func (o *PartnerDetailsDto) SetPartnerImageSettings(v PartnerImageSettingsDto) {
	o.PartnerImageSettings.Set(&v)
}
// SetPartnerImageSettingsNil sets the value for PartnerImageSettings to be an explicit nil
func (o *PartnerDetailsDto) SetPartnerImageSettingsNil() {
	o.PartnerImageSettings.Set(nil)
}

// UnsetPartnerImageSettings ensures that no value is present for PartnerImageSettings, not even an explicit nil
func (o *PartnerDetailsDto) UnsetPartnerImageSettings() {
	o.PartnerImageSettings.Unset()
}
...
func (o PartnerDetailsDto) ToMap() (map[string]interface{}, error) {
	...
	if o.PartnerColorSettings.IsSet() {
		toSerialize["partnerColorSettings"] = o.PartnerColorSettings.Get()
	}
	if o.PartnerImageSettings.IsSet() {
		toSerialize["partnerImageSettings"] = o.PartnerImageSettings.Get()
	}
