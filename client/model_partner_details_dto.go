...
func NewPartnerDetailsDto(id int32, name string, link NullableString, domain NullableString, country NullableString, city NullableString, vatNumber NullableString, backgroundImageUrl NullableString, address NullableString, logo NullableString, phone NullableString, email NullableString, paymentEnabled NullableBool, allowRegistration NullableBool, requiredUserApproval NullableBool, organizations []CommonDropdownDto) *PartnerDetailsDto {
