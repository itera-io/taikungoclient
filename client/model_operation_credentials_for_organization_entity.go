...
func NewOperationCredentialsForOrganizationEntity(operationCredentialId NullableInt32, name string, isDefault bool) *OperationCredentialsForOrganizationEntity {
