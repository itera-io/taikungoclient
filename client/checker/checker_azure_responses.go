...
func (o *CheckerAzureReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewCheckerAzureTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCheckerAzureTooManyRequests creates a CheckerAzureTooManyRequests with default headers values
func NewCheckerAzureTooManyRequests() *CheckerAzureTooManyRequests {
	return &CheckerAzureTooManyRequests{}
}

/* CheckerAzureTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type CheckerAzureTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *CheckerAzureTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Checker/azure][%d] checkerAzureTooManyRequests  %+v", 429, o.Payload)
}
func (o *CheckerAzureTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *CheckerAzureTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
