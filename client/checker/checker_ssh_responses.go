...
func (o *CheckerSSHReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewCheckerSSHTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCheckerSSHTooManyRequests creates a CheckerSSHTooManyRequests with default headers values
func NewCheckerSSHTooManyRequests() *CheckerSSHTooManyRequests {
	return &CheckerSSHTooManyRequests{}
}

/* CheckerSSHTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type CheckerSSHTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *CheckerSSHTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/Checker/ssh][%d] checkerSshTooManyRequests  %+v", 429, o.Payload)
}
func (o *CheckerSSHTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *CheckerSSHTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
