...
// Execute executes the request
//  @return int32
func (a *PartnersAPIService) PartnerCreateExecute(r ApiPartnerCreateRequest) (int32, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiPartnerDeleteRequest struct {
	ctx context.Context
	ApiService *PartnersAPIService
	deletePartnerCommand *DeletePartnerCommand
}

func (r ApiPartnerDeleteRequest) DeletePartnerCommand(deletePartnerCommand DeletePartnerCommand) ApiPartnerDeleteRequest {
	r.deletePartnerCommand = &deletePartnerCommand
	return r
}

func (r ApiPartnerDeleteRequest) Execute() (*http.Response, error) {
	return r.ApiService.PartnerDeleteExecute(r)
}
...
PartnerDelete Delete partner
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiPartnerDeleteRequest
*/
func (a *PartnersAPIService) PartnerDelete(ctx context.Context) ApiPartnerDeleteRequest {
	return ApiPartnerDeleteRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *PartnersAPIService) PartnerDeleteExecute(r ApiPartnerDeleteRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PartnersAPIService.PartnerDelete")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/partner/delete"
	...
	// body params
	localVarPostBody = r.deletePartnerCommand
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["Bearer"]; ok {
...
func (r ApiPartnerDropdownRequest) Execute() ([]PartnerEntity2, *http.Response, error) {
...
func (a *PartnersAPIService) PartnerDropdownExecute(r ApiPartnerDropdownRequest) ([]PartnerEntity2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []PartnerEntity2
	)
