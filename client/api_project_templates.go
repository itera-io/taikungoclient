...
func (r ApiProjectTemplatesCreateRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
func (a *ProjectTemplatesAPIService) ProjectTemplatesCreateExecute(r ApiProjectTemplatesCreateRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	if r.createProjectFromTemplateCommand == nil {
		return localVarReturnValue, nil, reportError("createProjectFromTemplateCommand is required and must be specified")
	}
