...
func (o *SecurityGroupCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewSecurityGroupCreateTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewSecurityGroupCreateTooManyRequests creates a SecurityGroupCreateTooManyRequests with default headers values
func NewSecurityGroupCreateTooManyRequests() *SecurityGroupCreateTooManyRequests {
	return &SecurityGroupCreateTooManyRequests{}
}

/* SecurityGroupCreateTooManyRequests describes a response with status code 429, with default header values.

Client Error
*/
type SecurityGroupCreateTooManyRequests struct {
	Payload *models.ProblemDetails
}

func (o *SecurityGroupCreateTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/v{v}/SecurityGroup/create][%d] securityGroupCreateTooManyRequests  %+v", 429, o.Payload)
}
func (o *SecurityGroupCreateTooManyRequests) GetPayload() *models.ProblemDetails {
	return o.Payload
}

func (o *SecurityGroupCreateTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
