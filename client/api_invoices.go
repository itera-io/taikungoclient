...
func (r ApiInvoicesUpdateRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
func (a *InvoicesAPIService) InvoicesUpdateExecute(r ApiInvoicesUpdateRequest) (map[string]interface{}, *http.Response, error) {
	var (
