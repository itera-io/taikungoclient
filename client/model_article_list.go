...
func NewArticleList(data []ArticlesListDto, offset int32, limit int32, hasMore bool, totalCount int32) *ArticleList {
	this := ArticleList{}
	this.Data = data
	this.Offset = offset
	this.Limit = limit
...
func (o *ArticleList) GetOffset() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ArticleList) GetOffsetOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ArticleList) SetOffset(v int32) {
	o.Offset = v
}

// GetLimit returns the Limit field value
func (o *ArticleList) GetLimit() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ArticleList) GetLimitOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Limit, true
...
func (o *ArticleList) SetLimit(v int32) {
	o.Limit = v
}

// GetHasMore returns the HasMore field value
func (o *ArticleList) GetHasMore() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ArticleList) GetHasMoreOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ArticleList) GetNextOffsetOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ArticleList) HasNextOffset() bool {
...
func (o *ArticleList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varArticleList)
