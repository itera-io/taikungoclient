...
func NewEditAlertingIntegrationCommand(id int32, url string, token string, alertingIntegrationType AlertingIntegrationType, alertingProfileId int32) *EditAlertingIntegrationCommand {
