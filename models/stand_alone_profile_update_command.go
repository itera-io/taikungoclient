...
func (m *StandAloneProfileUpdateCommand) validateID(formats strfmt.Registry) error {
...
func (m *StandAloneProfileUpdateCommand) validateName(formats strfmt.Registry) error {
