...
func (m *PatchPvcCommand) validateName(formats strfmt.Registry) error {
...
func (m *PatchPvcCommand) validateNamespace(formats strfmt.Registry) error {
...
func (m *PatchPvcCommand) validateProjectID(formats strfmt.Registry) error {
...
func (m *PatchPvcCommand) validateYaml(formats strfmt.Registry) error {
