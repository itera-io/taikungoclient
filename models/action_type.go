...
func init() {
	var res []ActionType
	if err := json.Unmarshal([]byte(`[10,20,30,32,34,36,38,40,42,44,50,60,70,80,90,100,110,120,130,140,150,155,156,160,165,170,175,176,177,180,190,200,210,220,230,240,250,260,270,280,290,300,310,320,330,340,350]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
