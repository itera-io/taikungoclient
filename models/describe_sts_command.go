...
func (m *DescribeStsCommand) validateName(formats strfmt.Registry) error {
...
func (m *DescribeStsCommand) validateNamespace(formats strfmt.Registry) error {
...
func (m *DescribeStsCommand) validateProjectID(formats strfmt.Registry) error {
