...
// BackupCredentialsSearchList backup credentials search list
//
// swagger:model BackupCredentialsSearchList
...
// Validate validates this backup credentials search list
func (m *BackupCredentialsSearchList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *BackupCredentialsSearchList) validateData(formats strfmt.Registry) error {
...
// ContextValidate validate this backup credentials search list based on the context it is used
func (m *BackupCredentialsSearchList) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *BackupCredentialsSearchList) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BackupCredentialsSearchList) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
