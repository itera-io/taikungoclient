...
func (m *PatchIngressCommand) validateName(formats strfmt.Registry) error {
...
func (m *PatchIngressCommand) validateNamespace(formats strfmt.Registry) error {
...
func (m *PatchIngressCommand) validateProjectID(formats strfmt.Registry) error {
...
func (m *PatchIngressCommand) validateYaml(formats strfmt.Registry) error {
