...
// ContextValidate validate this check aws command based on the context it is used
...
func (m *CheckAwsCommand) contextValidateRegion(ctx context.Context, formats strfmt.Registry) error {
